...
* [Quod Libet](https://github.com/quodlibet/quodlibet) ⭐ 1,749 | 🐛 887 | 🌐 Python | 📅 2026-08-02 - Cross-platform audio player providing many different ways to view local libraries `#python` `#gtk3`.
...
* [High Tide](https://github.com/Nokse22/high-tide) ⭐ 664 | 🐛 88 | 🌐 Python | 📅 2026-08-21 - Tidal streaming client `#python` `#gtk4` `#libadwaita`.
* [Riff](https://github.com/Diegovsky/riff) ⭐ 277 | 🐛 30 | 🌐 Rust | 📅 2026-08-21 - Spotify (premium) client for the GNOME desktop with MPRIS integration based on [librespot](https://github.com/librespot-org/librespot) ⭐ 6,969 | 🐛 130 | 🌐 Rust | 📅 2026-08-18, fork of [Spot](https://github.com/xou816/spot) ⭐ 2,372 | 🐛 114 | 🌐 Rust | 📅 2025-10-13 `#rust` `#gtk4` `#libadwaita`.
...
* [Euphonica](https://github.com/htkhiem/euphonica) ⭐ 869 | 🐛 60 | 🌐 Rust | 📅 2026-08-20 - Feature-packed MPD client with MPIRS support, customisable spectrum visualiser, dBFS readout support and more `#rust` `#gtk4` `#libadwaita`.
* [Mpdevil](https://github.com/SoongNoonien/mpdevil) ⭐ 250 | 🐛 3 | 🌐 Python | 📅 2026-08-17 - MPD music browser with MPRIS interface `#python` `#gtk4` `#libadwaita`.
...
* [zrythm](https://github.com/zrythm/zrythm) ⭐ 3,098 | 🐛 2 | 🌐 C++ | 📅 2026-08-18 - DAW offering streamlined editing workflows with automation capabilities, chord assistance and support for plugins `#c++` `#gtk4` `#libadwaita`.

### Audio Tools

* [SongRec](https://github.com/marin-m/SongRec) ⭐ 1,934 | 🐛 68 | 🌐 Rust | 📅 2026-08-20 - Shazam GUI client `#rust` `#gtk3`.
* [Lyrebird](https://github.com/lyrebird-voice-changer/lyrebird) ⚠️ Archived - (archived) Voice changer based on SoX `#python` `#gtk3`.
* [pwvucontrol](https://github.com/saivert/pwvucontrol) ⭐ 688 | 🐛 21 | 🌐 Rust | 📅 2026-08-21 - PipeWire volume mixer `#rust` `#gtk4` `#libadwaita`.
...
* [Simple Wireplumber GUI](https://github.com/dyegoaurelio/simple-wireplumber-gui) ⭐ 97 | 🐛 13 | 🌐 Python | 📅 2026-06-26 - WirePlumber (PipeWire session manager) GUI to rename devices and show properties. `#python` `#gtk4` `#libadwaita`.
...
* [Chronograph](https://github.com/Dzheremi2/Chronograph) ⭐ 81 | 🐛 6 | 🌐 Python | 📅 2026-02-15 - Application to sync lyrics of songs and contribute it to various resources `#python` `#gtk4` `#libadwaita`.
...
* [Transition](https://flathub.org/en/apps/page.codeberg.grinka.Transition) - Application for converting multimedia files to various audio formats `#rust` `#gtk4` `#libadwaita`.

[cava]: https://github.com/karlstav/cava

### Music Software

* [ALSA Scarlett2 Control Panel (alsa-scarlett-gui)](https://github.com/geoffreybennett/alsa-scarlett-gui) ⭐ 1,310 | 🐛 81 | 🌐 C | 📅 2026-06-22 - GUI for the Focusrite USB audio interfaces (Scarlett Gen 2, 3, 4, Clarett, and Vocaster) for instrument, microphone or MIDI recording `#c` `#gtk4`.
* [Drum Machine](https://github.com/Revisto/drum-machine) ⭐ 151 | 🐛 30 | 🌐 Python | 📅 2026-08-15 - Drum machine application to create and play drum beats `#python` `#gtk4` `#libadwaita` `#gnome`.
* [SysEx Controls](https://github.com/soyersoyer/sysex-controls) ⭐ 147 | 🐛 10 | 🌐 C | 📅 2026-04-07 - Application for configuring MIDI devices from Akai and Arturia `#c` `#gtk4` `#libadwaita`.
...
* [Celluloid](https://github.com/celluloid-player/celluloid) ⭐ 1,447 | 🐛 290 | 🌐 C | 📅 2026-07-17 - (ex GNOME MPV) frontend for MPV `#c` `#gtk4` `#libadwaita`.
...
* [Glide](https://github.com/philn/glide) ⭐ 286 | 🐛 9 | 🌐 Rust | 📅 2026-08-18 - Simple video player powered by GStreamer `#rust` `#gtk4` `#libadwaita`.
...
* [Kooha](https://github.com/SeaDve/Kooha) ⭐ 3,482 | 🐛 97 | 🌐 Rust | 📅 2026-07-29 - Distraction-free screen recorder `#rust` `#gtk4` `#libadwaita`.
...
* [Cameractrls](https://github.com/soyersoyer/cameractrls) ⭐ 948 | 🐛 45 | 🌐 Python | 📅 2026-07-16 - GUI and camera viewer (SDL) to set the camera controls (V4L2 or extensions) in Linux `#python` `#gtk4`.
...
* [ASCII Draw](https://github.com/Nokse22/ascii-draw) ⭐ 539 | 🐛 15 | 🌐 Python | 📅 2026-07-16 - App to draw diagrams or anything using only ASCII `#python` `#gtk4` `#libadwaita`.
...
* [Vipsdisp](https://github.com/jcupitt/vipsdisp) ⭐ 232 | 🐛 11 | 🌐 C | 📅 2026-07-20 - Image viewer capable of displaying huge (i.e. GB sizes) images based on [`libvips`](https://github.com/libvips/libvips) ⭐ 11,586 | 🐛 82 | 🌐 C | 📅 2026-08-20 and supporting many scientific and technical image formats `#c` `#gtk4`.
* [Fotema](https://github.com/blissd/fotema) ⭐ 193 | 🐛 69 | 🌐 Rust | 📅 2026-08-21 - Photo gallery with support for iOS Live Photos and Android motion photos `#rust` `#gtk4` `#libadwaita` `#relm4`.
...
* [Photos](https://github.com/elementary/photos) ⭐ 105 | 🐛 209 | 🌐 Vala | 📅 2026-08-21 - Photo viewer and organizer for elementary OS `#vala` `#gtk3` `#libhandy`.
...
* [Drawing](https://github.com/maoschanz/drawing) ⭐ 860 | 🐛 125 | 🌐 Python | 📅 2026-01-28 - Simple image editor similar to Microsoft paint designed for the GNOME desktop `#python` `#gtk3`.
* [Annotator](https://github.com/phase1geo/annotator) ⭐ 276 | 🐛 9 | 🌐 Vala | 📅 2026-07-17 - Image annotation application designed for elementary OS `#vala` `#gtk4` `#granite`.
...
* [Swappy](https://github.com/jtheoof/swappy) ⭐ 1,496 | 🐛 49 | 🌐 C | 📅 2025-12-16 - Wayland native screenshot editing tool `#c` `#gtk3`.
...
* [nip4](https://github.com/jcupitt/nip4) ⭐ 96 | 🐛 3 | 🌐 C | 📅 2026-08-21 - Spreadsheet-like GUI for the vips8 image processing library. `#c` `#gtk4`.
...
* [Upscaler](https://gitlab.com/TheEvilSkeleton/Upscaler) - Image upscaler based on [Real-ESRGAN ncnn Vulkan](https://github.com/xinntao/Real-ESRGAN-ncnn-vulkan) ⭐ 2,198 | 🐛 67 | 🌐 C | 📅 2024-05-10 `#python` `#gtk4` `#libadwaita`.
...
* [Birdfont](https://github.com/johanmattssonm/birdfont) ⭐ 554 | 🐛 79 | 🌐 Vala | 📅 2025-11-23 - Font editor for creating fonts in TTF, EOT, SVG and BIRDFONT formats `#vala` `#gtk3`.
...
* [Parabolic](https://github.com/NickvisionApps/Parabolic) ⭐ 6,908 | 🐛 92 | 🌐 C# | 📅 2026-06-29 - [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 186,056 | 🐛 2,598 | 🌐 Python | 📅 2026-08-20 graphical fronted `#csharp` `#gtk4` `#libadwaita`.
* [Gydl](https://github.com/JannikHv/gydl) ⭐ 156 | 🐛 16 | 🌐 Python | 📅 2025-11-28 - GUI wrapper around [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 140,983 | 🐛 4,128 | 🌐 Python | 📅 2026-02-19 `#python` `#gtk3`.
...
* [Overskride](https://github.com/kaii-lb/overskride) ⭐ 901 | 🐛 20 | 🌐 Rust | 📅 2026-06-13 - Bluetooth and Obex client/device manager `#rust` `#gtk4` `#libadwaita`.
...
* [Dissent](https://github.com/diamondburned/dissent) ⭐ 1,834 | 🐛 138 | 🌐 Go | 📅 2026-08-09 - Discord client `#go` `#gtk4` `#libadwaita`.
...
* [Discover](https://github.com/trigg/Discover) ⭐ 741 | 🐛 28 | 🌐 Python | 📅 2026-08-06 - Discord overlay with X11 and wlroots support `#python` `#gtk3`.
...
* [Vireo](https://github.com/hyprlab/vireo) ⭐ 30 | 🐛 12 | 🌐 Rust | 📅 2026-08-20 - Email client for the GNOME desktop that aims to be privacy-first, fast with a clean interface `#rust` `#gtk4` `#libadwaita`.
...
* [Varia](https://github.com/giantpinkrobots/varia) ⭐ 1,839 | 🐛 64 | 🌐 Python | 📅 2026-08-21 - Download manager based on [aria2](https://github.com/aria2/aria2) ⭐ 41,781 | 🐛 1,160 | 🌐 C++ | 📅 2026-06-25 `#python` `#gtk4` `#libadwaita`.
* [Warpinator](https://github.com/linuxmint/warpinator) ⭐ 1,575 | 🐛 80 | 🌐 C | 📅 2026-05-18 - Linux Mint's LAN file sharing program `#c++` `#gtk3`.
...
* [NM GUI](https://github.com/s-adi-dev/nmgui) ⭐ 266 | 🐛 8 | 🌐 Python | 📅 2025-10-30 - GUI for managing WiFi networks, using NetworkManager (`nmcli`) `#python` `#gtk4`.
...
* [Network Monitor](https://github.com/grigio/network-monitor) ⭐ 306 | 🐛 0 | 🌐 Rust | 📅 2026-08-17 - Real-time network connection monitoring tool with GUI & TUI `#rust` `#gtk4` `#libadwaita`.
...
* [Liferea](https://lzone.de/liferea) - News reader with a GUI similar to desktop mail client and with an embedded web browser `#c` `#gtk4` `#libadwaita`.
...
* [Field Monitor](https://github.com/theCapypara/field-monitor) ⭐ 90 | 🐛 20 | 🌐 Rust | 📅 2026-08-20 - Remote desktop client for the GNOME desktop with support for Proxmox & QEMU/KVM virtual machines `#rust` `#gtk4` `#libadwaita`.
...
* [Proton VPN](https://github.com/ProtonVPN/proton-vpn-gtk-app) ⭐ 730 | 🐛 70 | 🌐 Python | 📅 2026-08-10 - GTK fronted for Proton VPN `#python` `#gtk3`.

### Web Browsers

* [Add Water](https://flathub.org/en/apps/dev.qwery.AddWater) - Utility to install the [GNOME theme for Mozilla Firefox](https://github.com/rafaelmardojai/firefox-gnome-theme) ⭐ 3,896 | 🐛 52 | 🌐 CSS | 📅 2026-07-09 `#python`  `#gtk4` `#libadwaita`.
...
* [Linux Wifi Hotspot](https://github.com/lakinduakash/linux-wifi-hotspot) ⭐ 4,359 | 🐛 195 | 🌐 C | 📅 2026-02-25 - Feature-rich wifi hotspot creator for Linux which provides both GUI and command-line interface `#c` `#gtk3`.
...
* [Foliate](https://github.com/johnfactotum/foliate) ⭐ 8,652 | 🐛 316 | 🌐 JavaScript | 📅 2026-04-08 - Simple and modern eBook reader based on [Epub.js](https://github.com/futurepress/epub.js) ⭐ 6,945 | 🐛 517 | 🌐 JavaScript | 📅 2026-03-24 `#gjs` `#javascript` `#gtk4` `#libadwaita`.
...
* [NaSC](https://github.com/parnoldx/nasc) ⚠️ Archived - (archived, see [NaSCTUI](https://github.com/parnoldx/nascTUI) ⭐ 27 | 🐛 0 | 🌐 Go | 📅 2026-08-15) Dual pane text based calculator `#vala` `#gtk3` `#granite`.
...
* [Calculator](https://github.com/elementary/calculator) ⭐ 83 | 🐛 28 | 🌐 Vala | 📅 2026-08-17 - Calculator designed for elementary OS `#vala` `#gtk4` `#granite`.
...
* [Atril](https://github.com/mate-desktop/atril) ⭐ 248 | 🐛 187 | 🌐 C | 📅 2026-08-17 - Document viewer for the MATE desktop with support for PDF, PostScript (PS), Encapsulated PostScript (EPS), DJVU, DVI, and XPS (fork of Evince) `#c` `#gtk3`.
* [jumpdf](https://github.com/b43NnUNF4vidFYFhpqaLWy2ANawtRbMtUXZY9Pf/jumpdf) ⭐ 13 | 🐛 4 | 🌐 C | 📅 2026-08-20 - Keyboard-focused PDF viewer for documents where one needs to jump between different sections of the document frequently `#c` `#gtk4`.
...
* [Rnote](https://github.com/flxzt/rnote) ⭐ 11,569 | 🐛 448 | 🌐 Rust | 📅 2026-08-16 - Vector-based drawing app for sketching, handwritten notes and to annotate documents and pictures with pressure-sensitive stylus input support `#rust` `#gtk4` `#libadwaita`.
* [Zim](https://github.com/zim-desktop-wiki/zim-desktop-wiki) ⭐ 2,195 | 🐛 442 | 🌐 Python | 📅 2026-07-26 - Text editor used to maintain a collection of wiki pages `#python` `#gtk3`.
...
* [Notejot](https://github.com/lainsce/notejot) ⭐ 417 | 🐛 0 | 🌐 Vala | 📅 2025-10-05 - Stupidly simple notes application `#vala` `#gtk4` `#libadwaita`.
...
* [gImageReader](https://github.com/manisandro/gImageReader) ⭐ 1,982 | 🐛 73 | 🌐 C++ | 📅 2026-01-15 - GTK/Qt front-end to [Tesseract] `#c++` `#gtk3`.
* [TextSnatcher](https://github.com/RajSolai/TextSnatcher) ⭐ 1,386 | 🐛 43 | 🌐 Vala | 📅 2024-03-20 - Easy to use OCR application based on [Tesseract] `#vala` `#gtk3` `#granite`.
...
* [PDF Arranger](https://github.com/pdfarranger/pdfarranger) ⭐ 5,796 | 🐛 81 | 🌐 Python | 📅 2026-08-14 - PDF editor with merging, splitting, rotating, cropping and rearranging based on [pikepdf](https://github.com/pikepdf/pikepdf) ⭐ 2,794 | 🐛 20 | 🌐 Python | 📅 2026-08-18 `#python` `#gtk3` `#libhandy`.
...
* [Walker](https://github.com/abenz1267/walker) ⭐ 2,991 | 🐛 21 | 🌐 Rust | 📅 2026-07-23 - Customizable application launcher for Wayland `#rust` `#gtk4`.
* [StreamController](https://github.com/StreamController/StreamController) ⭐ 1,084 | 🐛 20 | 🌐 Python | 📅 2026-08-16 - Elgato Stream Deck controller with support for plugins `#python` `#gtk4` `#libadwaita`.
* [Szyszka](https://github.com/qarmin/szyszka) ⭐ 972 | 🐛 48 | 🌐 Rust | 📅 2026-06-06 - Fast bulk file renamer `#rust` `#gtk4`.
...
* [Wordbook](https://github.com/mufeedali/Wordbook) ⭐ 160 | 🐛 3 | 🌐 Python | 📅 2026-06-05 - Offline English-English dictionary application for the GNOME desktop using the Open English WordNet database and eSpeak for pronunciations `#python` `#gtk4` `#libadwaita` `#gnome`.
...
* [Minder](https://github.com/phase1geo/Minder) ⭐ 1,195 | 🐛 52 | 🌐 Vala | 📅 2026-07-20 - Mind-mapping application for elementary OS `#vala` `#gtk4` `#granite`.
...
* [Planify](https://github.com/alainm23/planify) ⭐ 5,597 | 🐛 162 | 🌐 Vala | 📅 2026-08-21 - Project and task manager with Todoist support `#vala` `#gtk4` `#libadwaita`.
...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,447 | 🐛 20 | 🌐 Python | 📅 2026-08-20 - Virtual assistant (based on GPT4All) that interacts with the system by running shell commands and execute Python code `#python` `#gtk4` `#libadwaita`.
...
* [OTPClient](https://github.com/paolostivanin/OTPClient) ⭐ 560 | 🐛 2 | 🌐 C | 📅 2026-08-21 - One Time Password application that supports both TOTP and HOTP `#c` `#gtk4` `#libadwaita`.
...
* [Hashes](https://github.com/zefr0x/hashes) ⭐ 29 | 🐛 1 | 🌐 Python | 📅 2026-06-12 - Identify hashing algorithms `#python` `#gtk4` `#libadwaita`.

## Finance

### Budget and Accounting Managers

* [Denaro](https://github.com/NickvisionApps/Denaro) ⭐ 840 | 🐛 42 | 🌐 C# | 📅 2025-03-24 - Personal finance manager for GNOME `#csharp` `#gtk4` `#libadwaita`.
...
* [WineCharm](https://github.com/fastrizwaan/WineCharm) ⭐ 31 | 🐛 0 | 🌐 Python | 📅 2026-08-04 - GUI designed to simplify running and managing Windows applications on Linux using Wine `#python` `#gtk4` `#libadwaita`.
...
* [Virtual Machine Manager (virt-manager)](https://github.com/virt-manager/virt-manager) ⭐ 3,227 | 🐛 161 | 🌐 Python | 📅 2026-08-15 - Graphical tool for managing virtual machines such as QEMU/KVM, Xen, LXC `#python` `#gtk3`.
* [Pods](https://github.com/marhkb/pods) ⭐ 1,078 | 🐛 39 | 🌐 Rust | 📅 2026-07-23 - Podman containers manager `#rust` `#gtk4` `#libadwaita`.
* [BoxBuddy](https://github.com/Dvlv/BoxBuddyRS) ⭐ 552 | 🐛 24 | 🌐 Rust | 📅 2026-08-15 - Graphical interface for Distrobox `#rust` `#gtk4` `#libadwaita`.
* [Atoms](https://github.com/AtomsDevs/Atoms) ⭐ 438 | 🐛 22 | 🌐 Python | 📅 2024-06-07 - Linux Chroot environments manager `#python` `#gtk4` `#libadwaita`.
...
* [Xed](https://github.com/linuxmint/xed) ⭐ 547 | 🐛 261 | 🌐 C | 📅 2026-08-21 - Small and lightweight text editor `#c` `#gtk3` `#libxapp`.
* [elementary Code](https://github.com/elementary/code) ⭐ 520 | 🐛 162 | 🌐 Vala | 📅 2026-08-19 - Code editor designed for elementary OS `#vala` `#gtk3` `#granite` `#elementary`.
...
* [Marker](https://github.com/fabiocolacio/Marker) ⭐ 864 | 🐛 133 | 🌐 JavaScript | 📅 2026-08-20 - Markdown editor with HTML and LaTeX conversion with [scidown](https://github.com/Mandarancio/scidown) ⭐ 55 | 🐛 6 | 🌐 C | 📅 2019-11-06 `#c` `#gtk3`.
* [Quilter](https://github.com/lainsce/quilter) ⭐ 296 | 🐛 0 | 🌐 Vala | 📅 2026-08-12 - Distraction-free Markdown editor `#vala` `#gtk4` `#libadwaita`.
...
* [Guake](https://github.com/Guake/guake) ⭐ 4,668 | 🐛 453 | 🌐 Python | 📅 2026-08-19 - Dropdown terminal for the GNOME desktop `#python` `#gtk3`.
...
* [Diffuse](https://github.com/MightyCreak/diffuse) ⭐ 334 | 🐛 47 | 🌐 Python | 📅 2026-03-13 - Text file comparing/merging tool `#python` `#gtk3`.
...
* [Flexa](https://github.com/EuCaue/Flexa) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-08-20 - Convert cursor themes between Windows and Linux formats `#python` `#gtk4` `#libadwaita`.
...
* [Timeshift](https://github.com/linuxmint/timeshift) ⭐ 4,241 | 🐛 234 | 🌐 Vala | 📅 2026-04-08 - System restore tool for Linux that creates filesystem snapshots using rsync or Btrfs snapshots `#vala` `#gtk3`.
...
* [Nemo](https://github.com/linuxmint/nemo) ⭐ 1,549 | 🐛 323 | 🌐 C | 📅 2026-08-21 - Default file manager of the Cinnamon desktop (fork of Nautilus) `#c` `#gtk3`.
* [Files (elementary)](https://github.com/elementary/files) ⭐ 365 | 🐛 316 | 🌐 Vala | 📅 2026-08-21 - File browser for elementary OS `#vala` `#gtk3` `#libhandy` `#granite`.
...
* [PCManFM](https://github.com/lxde/pcmanfm) ⭐ 250 | 🐛 34 | 🌐 C | 📅 2026-02-03 - Lightweight file manager, standard file manager for LXDE `#c` `#gtk3`.
...
* [FSearch](https://github.com/cboxdoerfer/fsearch) ⭐ 4,317 | 🐛 170 | 🌐 C | 📅 2026-08-16 - A fast file search utility `#c` `#gtk3`.
...
* [Syncthing-GTK](https://github.com/syncthing/syncthing-gtk) ⭐ 1,401 | 🐛 96 | 🌐 Python | 📅 2023-04-24 - UI for [Syncthing](https://syncthing.net) with the same features as the Web UI `#python` `#gtk3`.
...
* [Taxi](https://github.com/Alecaddd/taxi) ⭐ 105 | 🐛 23 | 🌐 Vala | 📅 2025-06-30 - FTP client designed for elementary OS that also supports SFTP, WebDAV and AFP `#vala` `#gtk4` `#granite` `#libadwaita`.
...
* [ProtonPlus](https://github.com/Vysp3r/ProtonPlus) ⭐ 1,722 | 🐛 20 | 🌐 Vala | 📅 2026-08-15 - Proton version manager `#vala` `#gtk4` `#libadwaita`.
* [Extension Manager](https://github.com/mjakeman/extension-manager) ⭐ 1,359 | 🐛 29 | 🌐 C | 📅 2026-08-21 - Utility for browsing and installing GNOME Shell Extensions `#c` `#gtk4` `#libadwaita`.
* [Shelly](https://github.com/Seafoam-Labs/Shelly-ALPM) ⭐ 1,027 | 🐛 47 | 🌐 Zig | 📅 2026-08-21 - Package manager for Arch Linux, CachyOS supporting AUR, Flathub, Flatpak, AppImage, and native Arch Linux packages `#zig` `#gtk4`.
* [Nix Software Center](https://github.com/snowfallorg/nix-software-center) ⭐ 844 | 🐛 59 | 🌐 Rust | 📅 2026-04-07 - Software center to easity install and manage Nix packages `#rust` `#gtk4` `#libadwaita` `#relm4`.
* [AdwSteamGtk](https://github.com/Foldex/AdwSteamGtk) ⭐ 385 | 🐛 6 | 🌐 Python | 📅 2026-04-10 - [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) ⭐ 1,581 | 🐛 15 | 🌐 CSS | 📅 2026-08-02 skin installer `#python` `#gtk4` `#libadwaita`.
* [Icicle](https://github.com/snowfallorg/icicle) ⭐ 107 | 🐛 9 | 🌐 Rust | 📅 2026-08-21 - Graphical installer for NixOS based distributions `#rust` `#gtk4` `#libadwaita` `#relm4`.
...
* [Czkawka](https://github.com/qarmin/czkawka) ⭐ 32,816 | 🐛 313 | 🌐 Fluent | 📅 2026-07-29 - Cross-platform, simple and fast application to remove unnecessary files from your computer `#rust` `#gtk4`.
* [Detwinner](https://neatdecisions.com/products/detwinner-linux) - Duplicate file finder `#c++` `#gtk3`.

### System Configuration

* [Solaar](https://github.com/pwr-Solaar/Solaar) ⭐ 9,272 | 🐛 95 | 🌐 Python | 📅 2026-08-18 - Manager for many Logitech keyboards, mice, and other devices that connect wirelessly to a Unifying, Bolt, Lightspeed or Nano receiver, USB cable or Bluetooth `#python` `#gtk3`.
* [LACT](https://github.com/ilya-zlobintsev/LACT) ⭐ 5,453 | 🐛 93 | 🌐 Rust | 📅 2026-08-20 - Application to control AMD, Nvidia or Intel graphical processing units (GPU) on Linux `#rust` `#gtk4` `#libadwaita`.
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 5,146 | 🐛 129 | 🌐 Rust | 📅 2026-06-28 - Mouse and keyboard sharing software (software KVM switch) designed for Wayland `#rust` `#gtk4` `#libadwaita`.
* [Hidamari](https://github.com/jeffshee/hidamari) ⭐ 2,090 | 🐛 129 | 🌐 Python | 📅 2026-07-09 - Application to configure video wallpaper for X11 and Wayland `#python` `#gtk3`.
* [Flatseal](https://github.com/tchx84/Flatseal) ⭐ 1,762 | 🐛 97 | 🌐 JavaScript | 📅 2026-08-10 - Flatpak permission manager `#gjs` `#javascript` `#gtk4` `#libadwaita`.
* [SaveDesktop](https://github.com/vikdevelop/SaveDesktop) ⭐ 803 | 🐛 0 | 🌐 Python | 📅 2026-08-08 - Plasma, Xfce and GNOME-based DE configuration saver (icons, fonts, themes, settings, background, GNOME extensions, Flatpak permissions and more) `#python` `#gtk4` `#libadwaita`.
* [ReGreet](https://github.com/rharish101/ReGreet) ⭐ 799 | 🐛 27 | 🌐 Rust | 📅 2026-07-17 - GTK-based [greetd](https://git.sr.ht/~kennylevinsen/greetd) greeter `#rust` `#gtk4` `#relm4`.
...
* [Warehouse](https://github.com/flattool/warehouse) ⭐ 624 | 🐛 71 | 🌐 Python | 📅 2026-07-22 - Toolbox for managing Flatpak packages (view info, manage user data, pin versions, change version, install/uninstall, etc.) `#python` `#gtk4` `#libadwaita`.
* [EasySSH](https://github.com/muriloventuroso/easyssh) ⭐ 552 | 🐛 55 | 🌐 Vala | 📅 2026-07-12 - SSH connection manager `#vala` `#gtk3`.
* [Luminance](https://github.com/sidevesh/Luminance) ⭐ 177 | 🐛 11 | 🌐 C | 📅 2026-08-09 - Simple application to control brightness of displays (including external) supporting DDC/CI `#c` `#gtk4` `#libadwaita`.
* [Dynamic Wallpaper](https://github.com/dusansimic/dynamic-wallpaper) ⭐ 155 | 🐛 22 | 🌐 Python | 📅 2024-11-09 - Dynamic wallpaper creator for GNOME 42 `#python` `#gtk4` `#libadwaita`.
* [Embellish](https://github.com/getnf/embellish) ⭐ 63 | 🐛 0 | 🌐 Vala | 📅 2026-08-03 - Application to install and manage Nerd Fonts on the system `#gjs` `#javascript` `#gtk4` `#libadwaita`.
* [Wardrobe](https://github.com/SwordPuffin/Wardrobe) ⭐ 35 | 🐛 3 | 🌐 Python | 📅 2026-06-19 - Utility to download GNOME shell extensions and GTK themes and icon packs `#python` `#gtk4` `#libadwaita`.
...
* [Packetry](https://github.com/greatscottgadgets/packetry) ⭐ 282 | 🐛 17 | 🌐 Rust | 📅 2026-08-12 - USB 2.0 protocol analysis application for use with the hardware device Cynthion `#rust` `#gtk4`.
...
* [Inspector](https://github.com/Nokse22/inspector) ⭐ 86 | 🐛 7 | 🌐 Python | 📅 2026-06-24 - Application to view system information such as USB/disk/PCIE/networks devices and motherboard/CPU information `#python` `#gtk4` `#libadwaita`.
...
* [An Anime Game launcher](https://github.com/an-anime-team/an-anime-game-launcher) ⭐ 2,209 | 🐛 111 | 🌐 Fluent | 📅 2026-07-23 - Genshin Impact launcher for Linux with telemetry disabling `#rust` `#gtk4` `#relm4` `#libadwaita`.
...
* [Keypunch](https://github.com/bragefuglseth/keypunch) ⭐ 283 | 🐛 21 | 🌐 Rust | 📅 2026-08-15 - Keyboard typing test like monkeytype `#rust` `#gtk4` `#libadwaita` `#gnome`.
* [Gameeky](https://github.com/tchx84/gameeky) ⭐ 140 | 🐛 15 | 🌐 Python | 📅 2025-10-13 - Application to create and play games without any code for young learners and educators `#python` `#gtk4` `#libadwaita`.
...
* [Throwdown](https://github.com/yioannides/throwdown) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2026-08-20 - Fun application for generating random skate trick combos with adjustable difficulty `#python` `#gtk4` `#libadwaita`.
...
* [Maps](https://github.com/elementary/maps) ⭐ 25 | 🐛 12 | 🌐 Vala | 📅 2026-08-03 - Map viewer designed for elementary OS `#vala` `#gtk4` `#granite` `#libadwaita`.
...
* [Mousam](https://github.com/amit9838/mousam) ⭐ 477 | 🐛 42 | 🌐 Python | 📅 2026-08-15 - Lightweight weather application with dynamically changing gradient-based background according to current weather condition `#python` `#gtk4` `#libadwaita`.
...
* [Butler](https://github.com/cassidyjames/butler) ⭐ 211 | 🐛 24 | 🌐 Vala | 📅 2026-08-20 - Native UI wrapper for the Home Assistant dashboard `#vala` `#gtk4` `#libadwaita`.
...
* [Fidei](https://github.com/sp1ritCS/fidei) ⭐ 10 | 🐛 2 | 🌐 C | 📅 2025-04-20 - Bible reader for the GNOME desktop `#c` `#gtk4` `#libadwaita`.
