...
* [Quod Libet](https://github.com/quodlibet/quodlibet) ⭐ 1,751 | 🐛 887 | 🌐 Python | 📅 2026-08-23 - Cross-platform audio player providing many different ways to view local libraries `#python` `#gtk3`.
...
* [High Tide](https://github.com/Nokse22/high-tide) ⭐ 671 | 🐛 90 | 🌐 Python | 📅 2026-08-21 - Tidal streaming client `#python` `#gtk4` `#libadwaita`.
* [Riff](https://github.com/Diegovsky/riff) ⭐ 292 | 🐛 30 | 🌐 Rust | 📅 2026-09-06 - Spotify (premium) client for the GNOME desktop with MPRIS integration based on [librespot](https://github.com/librespot-org/librespot) ⭐ 7,113 | 🐛 134 | 🌐 Rust | 📅 2026-09-01, fork of [Spot](https://github.com/xou816/spot) ⭐ 2,369 | 🐛 114 | 🌐 Rust | 📅 2025-10-13 `#rust` `#gtk4` `#libadwaita`.
...
* [Euphonica](https://github.com/htkhiem/euphonica) ⭐ 883 | 🐛 63 | 🌐 Rust | 📅 2026-09-06 - Feature-packed MPD client with MPIRS support, customisable spectrum visualiser, dBFS readout support and more `#rust` `#gtk4` `#libadwaita`.
...
* [zrythm](https://github.com/zrythm/zrythm) ⭐ 3,115 | 🐛 2 | 🌐 C++ | 📅 2026-09-07 - DAW offering streamlined editing workflows with automation capabilities, chord assistance and support for plugins `#c++` `#gtk4` `#libadwaita`.

### Audio Tools

* [SongRec](https://github.com/marin-m/SongRec) ⭐ 1,952 | 🐛 70 | 🌐 Rust | 📅 2026-09-05 - Shazam GUI client `#rust` `#gtk3`.
* [Lyrebird](https://github.com/lyrebird-voice-changer/lyrebird) ⚠️ Archived - (archived) Voice changer based on SoX `#python` `#gtk3`.
* [pwvucontrol](https://github.com/saivert/pwvucontrol) ⭐ 693 | 🐛 22 | 🌐 Rust | 📅 2026-08-21 - PipeWire volume mixer `#rust` `#gtk4` `#libadwaita`.
...
* [ALSA Scarlett2 Control Panel (alsa-scarlett-gui)](https://github.com/geoffreybennett/alsa-scarlett-gui) ⭐ 1,323 | 🐛 85 | 🌐 C | 📅 2026-06-22 - GUI for the Focusrite USB audio interfaces (Scarlett Gen 2, 3, 4, Clarett, and Vocaster) for instrument, microphone or MIDI recording `#c` `#gtk4`.
...
* [Drum Machine](https://github.com/Revisto/drum-machine) ⭐ 151 | 🐛 21 | 🌐 Python | 📅 2026-09-07 - Drum machine application to create and play drum beats `#python` `#gtk4` `#libadwaita` `#gnome`.
...
* [Kooha](https://github.com/SeaDve/Kooha) ⭐ 3,503 | 🐛 99 | 🌐 Rust | 📅 2026-09-07 - Distraction-free screen recorder `#rust` `#gtk4` `#libadwaita`.
...
* [Cameractrls](https://github.com/soyersoyer/cameractrls) ⭐ 950 | 🐛 52 | 🌐 Python | 📅 2026-07-16 - GUI and camera viewer (SDL) to set the camera controls (V4L2 or extensions) in Linux `#python` `#gtk4`.
...
* [Vipsdisp](https://github.com/jcupitt/vipsdisp) ⭐ 233 | 🐛 12 | 🌐 C | 📅 2026-08-30 - Image viewer capable of displaying huge (i.e. GB sizes) images based on [`libvips`](https://github.com/libvips/libvips) ⭐ 11,631 | 🐛 81 | 🌐 C | 📅 2026-09-06 and supporting many scientific and technical image formats `#c` `#gtk4`.
...
* [Photos](https://github.com/elementary/photos) ⭐ 104 | 🐛 210 | 🌐 Vala | 📅 2026-09-07 - Photo viewer and organizer for elementary OS `#vala` `#gtk3` `#libhandy`.
...
* [Drawing](https://github.com/maoschanz/drawing) ⭐ 867 | 🐛 127 | 🌐 Python | 📅 2026-01-28 - Simple image editor similar to Microsoft paint designed for the GNOME desktop `#python` `#gtk3`.
...
* [nip4](https://github.com/jcupitt/nip4) ⭐ 97 | 🐛 3 | 🌐 C | 📅 2026-09-08 - Spreadsheet-like GUI for the vips8 image processing library. `#c` `#gtk4`.
...
* [Upscaler](https://gitlab.com/TheEvilSkeleton/Upscaler) - Image upscaler based on [Real-ESRGAN ncnn Vulkan](https://github.com/xinntao/Real-ESRGAN-ncnn-vulkan) ⭐ 2,221 | 🐛 67 | 🌐 C | 📅 2024-05-10 `#python` `#gtk4` `#libadwaita`.

### Technical Graphics

* [Horizon](https://github.com/horizon-eda/horizon) ⭐ 1,315 | 🐛 162 | 🌐 C | 📅 2026-08-28 - EDA package supporting an integrated end-to-end workflow for printed circuit design `#c++` `#gtk3`.
...
* [Parabolic](https://github.com/NickvisionApps/Parabolic) ⭐ 7,026 | 🐛 96 | 🌐 C# | 📅 2026-06-29 - [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 189,837 | 🐛 2,640 | 🌐 Python | 📅 2026-08-30 graphical fronted `#csharp` `#gtk4` `#libadwaita`.
* [Gydl](https://github.com/JannikHv/gydl) ⭐ 156 | 🐛 16 | 🌐 Python | 📅 2025-11-28 - GUI wrapper around [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,161 | 🐛 4,125 | 🌐 Python | 📅 2026-02-19 `#python` `#gtk3`.
...
* [Overskride](https://github.com/kaii-lb/overskride) ⭐ 905 | 🐛 20 | 🌐 Rust | 📅 2026-09-01 - Bluetooth and Obex client/device manager `#rust` `#gtk4` `#libadwaita`.
...
* [Dissent](https://github.com/diamondburned/dissent) ⭐ 1,845 | 🐛 138 | 🌐 Go | 📅 2026-08-09 - Discord client `#go` `#gtk4` `#libadwaita`.
* [Paper Plane](https://github.com/paper-plane-developers/paper-plane) ⭐ 1,063 | 🐛 93 | 🌐 Rust | 📅 2025-01-26 - Telegram client for the GNOME desktop `#rust` `#gtk4` `#libadwaita`.
...
* [Vireo](https://github.com/hyprlab/vireo) ⭐ 59 | 🐛 7 | 🌐 Rust | 📅 2026-09-08 - Email client for the GNOME desktop that aims to be privacy-first, fast with a clean interface `#rust` `#gtk4` `#libadwaita`.
...
* [Varia](https://github.com/giantpinkrobots/varia) ⭐ 1,855 | 🐛 58 | 🌐 Python | 📅 2026-09-04 - Download manager based on [aria2](https://github.com/aria2/aria2) ⭐ 41,953 | 🐛 1,177 | 🌐 C++ | 📅 2026-06-25 `#python` `#gtk4` `#libadwaita`.
...
* [Proton VPN](https://github.com/ProtonVPN/proton-vpn-gtk-app) ⭐ 750 | 🐛 80 | 🌐 Python | 📅 2026-08-31 - GTK fronted for Proton VPN `#python` `#gtk3`.
...
* [Linux Wifi Hotspot](https://github.com/lakinduakash/linux-wifi-hotspot) ⭐ 4,377 | 🐛 195 | 🌐 Shell | 📅 2026-09-06 - Feature-rich wifi hotspot creator for Linux which provides both GUI and command-line interface `#c` `#gtk3`.
...
* [Foliate](https://github.com/johnfactotum/foliate) ⭐ 8,691 | 🐛 318 | 🌐 JavaScript | 📅 2026-04-08 - Simple and modern eBook reader based on [Epub.js](https://github.com/futurepress/epub.js) ⭐ 6,958 | 🐛 517 | 🌐 JavaScript | 📅 2026-03-24 `#gjs` `#javascript` `#gtk4` `#libadwaita`.
...
* [Calculator](https://github.com/elementary/calculator) ⭐ 83 | 🐛 29 | 🌐 Vala | 📅 2026-09-07 - Calculator designed for elementary OS `#vala` `#gtk4` `#granite`.
...
* [Rnote](https://github.com/flxzt/rnote) ⭐ 11,625 | 🐛 451 | 🌐 Rust | 📅 2026-09-08 - Vector-based drawing app for sketching, handwritten notes and to annotate documents and pictures with pressure-sensitive stylus input support `#rust` `#gtk4` `#libadwaita`.
* [Zim](https://github.com/zim-desktop-wiki/zim-desktop-wiki) ⭐ 2,201 | 🐛 441 | 🌐 Python | 📅 2026-09-01 - Text editor used to maintain a collection of wiki pages `#python` `#gtk3`.
...
* [gImageReader](https://github.com/manisandro/gImageReader) ⭐ 1,991 | 🐛 74 | 🌐 C++ | 📅 2026-01-15 - GTK/Qt front-end to [Tesseract] `#c++` `#gtk3`.
...
* [PDF Arranger](https://github.com/pdfarranger/pdfarranger) ⭐ 5,858 | 🐛 85 | 🌐 Python | 📅 2026-09-01 - PDF editor with merging, splitting, rotating, cropping and rearranging based on [pikepdf](https://github.com/pikepdf/pikepdf) ⭐ 2,798 | 🐛 18 | 🌐 Python | 📅 2026-09-06 `#python` `#gtk3` `#libhandy`.
...
* [Walker](https://github.com/abenz1267/walker) ⭐ 3,033 | 🐛 25 | 🌐 Rust | 📅 2026-07-23 - Customizable application launcher for Wayland `#rust` `#gtk4`.
* [StreamController](https://github.com/StreamController/StreamController) ⭐ 1,104 | 🐛 31 | 🌐 Python | 📅 2026-09-02 - Elgato Stream Deck controller with support for plugins `#python` `#gtk4` `#libadwaita`.
...
* [Minder](https://github.com/phase1geo/Minder) ⭐ 1,201 | 🐛 51 | 🌐 Vala | 📅 2026-07-20 - Mind-mapping application for elementary OS `#vala` `#gtk4` `#granite`.

### Project Management

* [Planify](https://github.com/alainm23/planify) ⭐ 5,664 | 🐛 165 | 🌐 Vala | 📅 2026-09-08 - Project and task manager with Todoist support `#vala` `#gtk4` `#libadwaita`.
...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,465 | 🐛 22 | 🌐 Python | 📅 2026-09-01 - Virtual assistant (based on GPT4All) that interacts with the system by running shell commands and execute Python code `#python` `#gtk4` `#libadwaita`.
...
* [Virtual Machine Manager (virt-manager)](https://github.com/virt-manager/virt-manager) ⭐ 3,246 | 🐛 156 | 🌐 Python | 📅 2026-09-04 - Graphical tool for managing virtual machines such as QEMU/KVM, Xen, LXC `#python` `#gtk3`.
...
* [Comma](https://github.com/excelano/comma) ⭐ 6 | 🐛 1 | 🌐 Rust | 📅 2026-09-07 - Minimal editor for CSV, TSV, and other delimited text files `#rust` `#gtk4` `#libadwaita`.
...
* [Files (elementary)](https://github.com/elementary/files) ⭐ 365 | 🐛 333 | 🌐 Vala | 📅 2026-09-08 - File browser for elementary OS `#vala` `#gtk3` `#libhandy` `#granite`.
...
* [FSearch](https://github.com/cboxdoerfer/fsearch) ⭐ 4,350 | 🐛 173 | 🌐 C | 📅 2026-08-26 - A fast file search utility `#c` `#gtk3`.
...
* [ProtonPlus](https://github.com/Vysp3r/ProtonPlus) ⭐ 1,764 | 🐛 51 | 🌐 Vala | 📅 2026-09-08 - Proton version manager `#vala` `#gtk4` `#libadwaita`.
...
* [Shelly](https://github.com/Seafoam-Labs/Shelly-ALPM) ⭐ 1,108 | 🐛 52 | 🌐 Zig | 📅 2026-09-08 - Package manager for Arch Linux, CachyOS supporting AUR, Flathub, Flatpak, AppImage, and native Arch Linux packages `#zig` `#gtk4`.
...
* [Czkawka](https://github.com/qarmin/czkawka) ⭐ 33,357 | 🐛 322 | 🌐 Fluent | 📅 2026-09-08 - Cross-platform, simple and fast application to remove unnecessary files from your computer `#rust` `#gtk4`.
...
* [Solaar](https://github.com/pwr-Solaar/Solaar) ⭐ 9,342 | 🐛 105 | 🌐 Python | 📅 2026-08-18 - Manager for many Logitech keyboards, mice, and other devices that connect wirelessly to a Unifying, Bolt, Lightspeed or Nano receiver, USB cable or Bluetooth `#python` `#gtk3`.
* [LACT](https://github.com/ilya-zlobintsev/LACT) ⭐ 5,558 | 🐛 96 | 🌐 Rust | 📅 2026-09-07 - Application to control AMD, Nvidia or Intel graphical processing units (GPU) on Linux `#rust` `#gtk4` `#libadwaita`.
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 5,242 | 🐛 136 | 🌐 Rust | 📅 2026-09-07 - Mouse and keyboard sharing software (software KVM switch) designed for Wayland `#rust` `#gtk4` `#libadwaita`.
* [Hidamari](https://github.com/jeffshee/hidamari) ⭐ 2,102 | 🐛 129 | 🌐 Python | 📅 2026-07-09 - Application to configure video wallpaper for X11 and Wayland `#python` `#gtk3`.
* [Flatseal](https://github.com/tchx84/Flatseal) ⭐ 1,770 | 🐛 96 | 🌐 JavaScript | 📅 2026-08-31 - Flatpak permission manager `#gjs` `#javascript` `#gtk4` `#libadwaita`.
* [ReGreet](https://github.com/rharish101/ReGreet) ⭐ 814 | 🐛 27 | 🌐 Rust | 📅 2026-07-17 - GTK-based [greetd](https://git.sr.ht/~kennylevinsen/greetd) greeter `#rust` `#gtk4` `#relm4`.
...
* [Monitor](https://github.com/stsdc/monitor) ⭐ 363 | 🐛 39 | 🌐 Vala | 📅 2026-09-07 - Manage processes and monitor system resources `#vala` `#gtk4` `#libadwaita` `#granite`.
...
* [DeSmuME](https://github.com/TASEmulators/desmume) ⭐ 3,625 | 🐛 92 | 🌐 C++ | 📅 2026-08-13 - Cross-platform Nintendo DS emulator `#c++` `#gtk3`.
* [An Anime Game launcher](https://github.com/an-anime-team/an-anime-game-launcher) ⭐ 2,240 | 🐛 110 | 🌐 Fluent | 📅 2026-09-01 - Genshin Impact launcher for Linux with telemetry disabling `#rust` `#gtk4` `#relm4` `#libadwaita`.
...
* [Keypunch](https://github.com/bragefuglseth/keypunch) ⭐ 282 | 🐛 21 | 🌐 Rust | 📅 2026-09-07 - Keyboard typing test like monkeytype `#rust` `#gtk4` `#libadwaita` `#gnome`.
...
* [Mousam](https://github.com/amit9838/mousam) ⭐ 480 | 🐛 45 | 🌐 Python | 📅 2026-08-25 - Lightweight weather application with dynamically changing gradient-based background according to current weather condition `#python` `#gtk4` `#libadwaita`.
