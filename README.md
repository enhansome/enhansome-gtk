...
* [Quod Libet](https://github.com/quodlibet/quodlibet) ⭐ 1,748 | 🐛 887 | 🌐 Python | 📅 2026-08-02 - Cross-platform audio player providing many different ways to view local libraries `#python` `#gtk3`.
* [Resonance](https://github.com/nate-xyz/resonance) ⭐ 429 | 🐛 112 | 🌐 Rust | 📅 2024-06-17 - Music player with MPRIS support, Discord Rich presence and Last.fm scrobbling `#rust` `#python` `#gtk4` `#libadwaita`.
...
* [elementary Music](https://github.com/elementary/music) ⭐ 149 | 🐛 48 | 🌐 Vala | 📅 2026-07-25 - Official music player for elementary OS `#vala` `#gtk4` `#granite` `#libadwaita` `#elementary`.
...
* [High Tide](https://github.com/Nokse22/high-tide) ⭐ 659 | 🐛 90 | 🌐 Python | 📅 2026-08-05 - Tidal streaming client `#python` `#gtk4` `#libadwaita`.
* [Riff](https://github.com/Diegovsky/riff) ⭐ 277 | 🐛 30 | 🌐 Rust | 📅 2026-08-12 - Spotify (premium) client for the GNOME desktop with MPRIS integration based on [librespot](https://github.com/librespot-org/librespot) ⭐ 6,957 | 🐛 122 | 🌐 Rust | 📅 2026-07-15, fork of [Spot](https://github.com/xou816/spot) ⭐ 2,376 | 🐛 114 | 🌐 Rust | 📅 2025-10-13 `#rust` `#gtk4` `#libadwaita`.
* [Subsound-GTK](https://github.com/esiqveland/subsound-gtk) ⭐ 9 | 🐛 14 | 🌐 Java | 📅 2026-08-09 - Subsonic compatible music player `#java` `#gtk4` `#libadwaita`.
...
* [Euphonica](https://github.com/htkhiem/euphonica) ⭐ 855 | 🐛 76 | 🌐 Rust | 📅 2026-08-11 - Feature-packed MPD client with MPIRS support, customisable spectrum visualiser, dBFS readout support and more `#rust` `#gtk4` `#libadwaita`.
* [Mpdevil](https://github.com/SoongNoonien/mpdevil) ⭐ 252 | 🐛 3 | 🌐 Python | 📅 2026-08-10 - MPD music browser with MPRIS interface `#python` `#gtk4` `#libadwaita`.
* [Sonata](https://github.com/multani/sonata) ⭐ 132 | 🐛 43 | 🌐 Python | 📅 2025-12-09 - MPD client with tag editor and audio scrobbling support, currently looking for a new maintainer `#python` `#gtk3`.
...
* [radiotray-lite](https://github.com/thekvs/radiotray-lite) ⭐ 54 | 🐛 13 | 🌐 C++ | 📅 2018-08-29 - Online radio player with minimal interface that runs on the system tray `#c++` `#gtk3`.
...
* [Parlatype](https://github.com/gkarsay/parlatype) ⭐ 176 | 🐛 23 | 🌐 C | 📅 2026-06-22 - Minimal audio player for manual speech transcription `#c` `#gtk4` `#libadwaita`.
...
* [zrythm](https://github.com/zrythm/zrythm) ⭐ 3,092 | 🐛 2 | 🌐 C++ | 📅 2026-08-12 - DAW offering streamlined editing workflows with automation capabilities, chord assistance and support for plugins `#c++` `#gtk4` `#libadwaita`.

### Audio Tools

* [SongRec](https://github.com/marin-m/SongRec) ⭐ 1,927 | 🐛 68 | 🌐 Rust | 📅 2026-08-11 - Shazam GUI client `#rust` `#gtk3`.
* [Lyrebird](https://github.com/lyrebird-voice-changer/lyrebird) ⚠️ Archived - (archived) Voice changer based on SoX `#python` `#gtk3`.
* [pwvucontrol](https://github.com/saivert/pwvucontrol) ⭐ 680 | 🐛 21 | 🌐 Rust | 📅 2026-08-12 - PipeWire volume mixer `#rust` `#gtk4` `#libadwaita`.
* [Tagger](https://github.com/NickvisionApps/Tagger) ⭐ 312 | 🐛 27 | 🌐 C# | 📅 2024-08-07 - Music tag (metadata) editor `#csharp` `#gtk4` `#libadwaita`.
* [Cavalier](https://github.com/NickvisionApps/Cavalier) ⭐ 272 | 🐛 22 | 🌐 C# | 📅 2025-04-21 - Audio visualizer based on [CAVA] `#csharp` `#gtk4` `#libadwaita`.
* [Myxer](https://github.com/VixenUtils/Myxer) ⭐ 264 | 🐛 5 | 🌐 Rust | 📅 2025-10-29 - PulseAudio volume mixer `#rust` `#gtk3`.
* [Reco](https://github.com/ryonakano/reco) ⭐ 126 | 🐛 41 | 🌐 Vala | 📅 2026-07-27 - Audio recorder `#vala` `#gtk4` `#granite`.
* [Simple Wireplumber GUI](https://github.com/dyegoaurelio/simple-wireplumber-gui) ⭐ 96 | 🐛 13 | 🌐 Python | 📅 2026-06-26 - WirePlumber (PipeWire session manager) GUI to rename devices and show properties. `#python` `#gtk4` `#libadwaita`.
* [Whisper](https://github.com/mijorus/whisper) ⭐ 91 | 🐛 5 | 🌐 Python | 📅 2026-04-18 - Application to listen to the microphone through the speakers `#python` `#gtk4` `#libadwaita`.
* [Chronograph](https://github.com/Dzheremi2/Chronograph) ⭐ 79 | 🐛 6 | 🌐 Python | 📅 2026-02-15 - Application to sync lyrics of songs and contribute it to various resources `#python` `#gtk4` `#libadwaita`.
* [Pro Audio Config](https://github.com/Peter-L-SVK/pro_audio_config) ⭐ 42 | 🐛 1 | 🌐 Rust | 📅 2026-05-25 - Professional audio configuration tool to manage PipeWire and ALSA audio settings, incl. sample rates, bit depths, and buffer sizes `#rust` `#gtk3`.
...
* [ALSA Scarlett2 Control Panel (alsa-scarlett-gui)](https://github.com/geoffreybennett/alsa-scarlett-gui) ⭐ 1,305 | 🐛 79 | 🌐 C | 📅 2026-06-22 - GUI for the Focusrite USB audio interfaces (Scarlett Gen 2, 3, 4, Clarett, and Vocaster) for instrument, microphone or MIDI recording `#c` `#gtk4`.
* [Drum Machine](https://github.com/Revisto/drum-machine) ⭐ 150 | 🐛 29 | 🌐 Python | 📅 2026-07-27 - Drum machine application to create and play drum beats `#python` `#gtk4` `#libadwaita` `#gnome`.
* [SysEx Controls](https://github.com/soyersoyer/sysex-controls) ⭐ 144 | 🐛 10 | 🌐 C | 📅 2026-04-07 - Application for configuring MIDI devices from Akai and Arturia `#c` `#gtk4` `#libadwaita`.
* [Glight](https://github.com/aroffringa/glight) ⭐ 60 | 🐛 31 | 🌐 C++ | 📅 2026-06-12 - DMX controller software for live control of stage lighting, suitable for shows and events `#c++` `#gtk4`.
* [Chromatic](https://github.com/nate-xyz/chromatic) ⭐ 46 | 🐛 12 | 🌐 Rust | 📅 2024-03-15 - Instruments tuner `#rust` `#gtk4` `#libadwaita`.
* [Oscmix](https://github.com/huddx01/oscmix) ⭐ 29 | 🐛 13 | 🌐 C | 📅 2026-08-03 - Mixer for RME Fireface Devices in CC Mode. Currently supported: 802, UCX, UCX II, UFX+, UFX II, UFX III `#c` `#gtk3`.
...
* [Celluloid](https://github.com/celluloid-player/celluloid) ⭐ 1,446 | 🐛 289 | 🌐 C | 📅 2026-07-17 - (ex GNOME MPV) frontend for MPV `#c` `#gtk4` `#libadwaita`.
* [Clapper](https://github.com/Rafostar/clapper) ⭐ 973 | 🐛 133 | 🌐 C | 📅 2026-07-20 - Media player powered by GStreamer with OpenGL rendering `#c` `#gtk4` `#libadwaita`.
* [Glide](https://github.com/philn/glide) ⭐ 286 | 🐛 8 | 🌐 Rust | 📅 2026-08-13 - Simple video player powered by GStreamer `#rust` `#gtk4` `#libadwaita`.
* [Videos](https://github.com/elementary/videos) ⭐ 57 | 🐛 45 | 🌐 Vala | 📅 2026-08-01 - Video player and library application for elementary OS  `#vala` `#gtk4` `#libadwaita`.
...
* [Multiplex](https://github.com/pojntfx/multiplex) ⭐ 393 | 🐛 11 | 🌐 Go | 📅 2026-05-11 - Application to stream and watch torrents together, providing an experience similar to Apple's SharePlay and Amazon's Prime Video Watch Party `#go` `#gtk4` `#libadwaita`.
* [TVDemon](https://github.com/DYefremov/TVDemon) ⭐ 26 | 🐛 3 | 🌐 Python | 📅 2026-08-02 - IPTV streaming application with support for live TV, movies and series `#python` `#gtk4` `#libadwaita`.
...
* [Kooha](https://github.com/SeaDve/Kooha) ⭐ 3,475 | 🐛 96 | 🌐 Rust | 📅 2026-07-29 - Distraction-free screen recorder `#rust` `#gtk4` `#libadwaita`.
* [Kazam2](https://github.com/henrywoo/kazam) ⭐ 386 | 🐛 31 | 🌐 Python | 📅 2026-07-29 - Versatile tool for screen recording, broadcasting, capturing and optical character recognition `#python` `#gtk3`.
...
* [Cameractrls](https://github.com/soyersoyer/cameractrls) ⭐ 937 | 🐛 45 | 🌐 Python | 📅 2026-07-16 - GUI and camera viewer (SDL) to set the camera controls (V4L2 or extensions) in Linux `#python` `#gtk4`.
...
* [ASCII Draw](https://github.com/Nokse22/ascii-draw) ⭐ 534 | 🐛 14 | 🌐 Python | 📅 2026-07-16 - App to draw diagrams or anything using only ASCII `#python` `#gtk4` `#libadwaita`.
* [Halftone](https://github.com/tfuxu/Halftone) ⭐ 145 | 🐛 17 | 🌐 Python | 📅 2026-07-29 - Image to pixel art converter `#python` `#gtk4` `#libadwaita`.
* [Letterpress](https://apps.gnome.org/Letterpress) - Image to ASCII art converter using [jp2a](https://github.com/Talinx/jp2a) ⭐ 99 | 🐛 3 | 🌐 HTML | 📅 2025-12-16 `#python` `#gtk4` `#libadwaita` `#gnome`.
* [Calligraphy](https://gitlab.com/gregorni/Calligraphy) - Text to ASCII banners converter `#python` `#gtk4` `#libadwaita`.

### Image Viewers

* [Pix](https://github.com/linuxmint/pix) ⭐ 265 | 🐛 119 | 🌐 C | 📅 2026-04-08 - Image viewer and browser `#c` `#gtk3` `#libxapp`.
* [Vipsdisp](https://github.com/jcupitt/vipsdisp) ⭐ 230 | 🐛 10 | 🌐 C | 📅 2026-07-20 - Image viewer capable of displaying huge (i.e. GB sizes) images based on [`libvips`](https://github.com/libvips/libvips) ⭐ 11,571 | 🐛 83 | 🌐 C | 📅 2026-08-13 and supporting many scientific and technical image formats `#c` `#gtk4`.
* [Fotema](https://github.com/blissd/fotema) ⭐ 191 | 🐛 74 | 🌐 Rust | 📅 2026-08-10 - Photo gallery with support for iOS Live Photos and Android motion photos `#rust` `#gtk4` `#libadwaita` `#relm4`.
...
* [Photos](https://github.com/elementary/photos) ⭐ 105 | 🐛 209 | 🌐 Vala | 📅 2026-08-12 - Photo viewer and organizer for elementary OS `#vala` `#gtk3` `#libhandy`.
...
* [MView6](https://github.com/newinnovations/MView6) ⭐ 14 | 🐛 1 | 🌐 Rust | 📅 2026-07-22 - High-performance PDF and photo viewer for large photo and document collections  `#rust` `#gtk4`.
...
* [Drawing](https://github.com/maoschanz/drawing) ⭐ 859 | 🐛 124 | 🌐 Python | 📅 2026-01-28 - Simple image editor similar to Microsoft paint designed for the GNOME desktop `#python` `#gtk3`.
* [Annotator](https://github.com/phase1geo/annotator) ⭐ 275 | 🐛 8 | 🌐 Vala | 📅 2026-07-17 - Image annotation application designed for elementary OS `#vala` `#gtk4` `#granite`.
* [Conjure](https://github.com/nate-xyz/conjure) ⭐ 90 | 🐛 20 | 🌐 Python | 📅 2024-06-19 - Image enhancer based on [ImageMagick] `#python` `#gtk4` `#libadwaita`.
* [RS-Paint](https://github.com/lucasscharenbroch/rs-paint) ⭐ 15 | 🐛 0 | 🌐 Rust | 📅 2026-05-21 - A light-weight image editor inspired by MS-Paint `#rust` `#gtk4`.
...
* [Swappy](https://github.com/jtheoof/swappy) ⭐ 1,494 | 🐛 49 | 🌐 C | 📅 2025-12-16 - Wayland native screenshot editing tool `#c` `#gtk3`.

#### GIF

* [Fig](https://github.com/Q1CHENL/fig) ⭐ 20 | 🐛 4 | 🌐 Python | 📅 2025-10-10 - GIF editor (cropping, trimming, reversing, removing/extracting frames) `#python` `#gtk4` `#libadwaita`.
* [Gifup](https://github.com/BharatKalluri/Gifup) ⭐ 17 | 🐛 6 | 🌐 Vala | 📅 2021-04-06 - Video-to-GIF converter `#vala` `#gtk3` `#granite`.
...
* [nip4](https://github.com/jcupitt/nip4) ⭐ 94 | 🐛 3 | 🌐 C | 📅 2026-08-13 - Spreadsheet-like GUI for the vips8 image processing library. `#c` `#gtk4`.
...
* [Upscaler](https://gitlab.com/TheEvilSkeleton/Upscaler) - Image upscaler based on [Real-ESRGAN ncnn Vulkan](https://github.com/xinntao/Real-ESRGAN-ncnn-vulkan) ⭐ 2,185 | 🐛 67 | 🌐 C | 📅 2024-05-10 `#python` `#gtk4` `#libadwaita`.

### Technical Graphics

* [Horizon](https://github.com/horizon-eda/horizon) ⭐ 1,306 | 🐛 162 | 🌐 C | 📅 2026-07-28 - EDA package supporting an integrated end-to-end workflow for printed circuit design `#c++` `#gtk3`.
...
* [Design](https://github.com/dubstar-04/Design) ⭐ 185 | 🐛 50 | 🌐 JavaScript | 📅 2026-08-05 - 2D CAD application with DXF format support `#gjs` `#javascript` `#gtk4` `#libadwaita`.
* [Delineate](https://github.com/SeaDve/Delineate) ⭐ 110 | 🐛 9 | 🌐 Rust | 📅 2026-08-12 - [Graphviz] DOT graphs viewer and editor `#rust` `#gtk4` `#libadwaita`.
* [rlr](https://github.com/epilys/rlr) ⭐ 76 | 🐛 2 | 🌐 Rust | 📅 2025-09-15 -  Interactive pixel screen ruler and protractor `#rust` `#gtk3`.
...
* [Photometric Viewer (Photometry)](https://github.com/dlippok/photometric-viewer) ⭐ 16 | 🐛 8 | 🌐 Python | 📅 2026-08-10 - IESNA and EULUMDAT photometric files viewer `#python` `#gtk4` `#libadwaita`.
...
* [Length](https://flathub.org/en/apps/io.github.herve4m.Length) - GNOME application for measuring distances on screen to design and inspect layouts and graphics `#python` `#gtk4` `#libadwaita`.
...
* [Birdfont](https://github.com/johanmattssonm/birdfont) ⭐ 550 | 🐛 79 | 🌐 Vala | 📅 2025-11-23 - Font editor for creating fonts in TTF, EOT, SVG and BIRDFONT formats `#vala` `#gtk3`.
...
* [Mingle](https://github.com/halfmexican/mingle) ⭐ 53 | 🐛 4 | 🌐 Vala | 📅 2026-04-09 - Application to combine emojis using Google's Emoji Kitchen `#vala` `#gtk4` `#libadwaita`.
...
* [Sitra](https://flathub.org/en/apps/io.github.sitraorg.sitra) - Application to preview and install fonts from Google Fonts `#vala` `#gtk4` `#libadwaita`.
...
* [Parabolic](https://github.com/NickvisionApps/Parabolic) ⭐ 6,844 | 🐛 86 | 🌐 C# | 📅 2026-06-29 - [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 184,256 | 🐛 2,608 | 🌐 Python | 📅 2026-08-04 graphical fronted `#csharp` `#gtk4` `#libadwaita`.
* [Gydl](https://github.com/JannikHv/gydl) ⭐ 156 | 🐛 16 | 🌐 Python | 📅 2025-11-28 - GUI wrapper around [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 140,957 | 🐛 4,129 | 🌐 Python | 📅 2026-02-19 `#python` `#gtk3`.
...
* [Overskride](https://github.com/kaii-lb/overskride) ⭐ 898 | 🐛 20 | 🌐 Rust | 📅 2026-06-13 - Bluetooth and Obex client/device manager `#rust` `#gtk4` `#libadwaita`.
* [IP Lookup](https://github.com/Bytezz/IPLookup-gtk) ⭐ 44 | 🐛 0 | 🌐 Python | 📅 2026-01-30 - Simple application to find information about an IP address `#python` `#gtk4` `#libadwaita`.

### Chat, VoIP, and Phone

* [Dissent](https://github.com/diamondburned/dissent) ⭐ 1,829 | 🐛 138 | 🌐 Go | 📅 2026-08-09 - Discord client `#go` `#gtk4` `#libadwaita`.
* [Paper Plane](https://github.com/paper-plane-developers/paper-plane) ⭐ 1,061 | 🐛 93 | 🌐 Rust | 📅 2025-01-26 - Telegram client for the GNOME desktop `#rust` `#gtk4` `#libadwaita`.
* [Discover](https://github.com/trigg/Discover) ⭐ 740 | 🐛 28 | 🌐 Python | 📅 2026-08-06 - Discord overlay with X11 and wlroots support `#python` `#gtk3`.
...
* [Mail](https://github.com/elementary/mail) ⭐ 215 | 🐛 175 | 🌐 Vala | 📅 2026-08-13 - Email application for the elementary OS desktop `#vala` `#gtk3` `#libhandy` `#granite`.

### File Sharing

* [Varia](https://github.com/giantpinkrobots/varia) ⭐ 1,831 | 🐛 63 | 🌐 Python | 📅 2026-08-12 - Download manager based on [aria2](https://github.com/aria2/aria2) ⭐ 41,709 | 🐛 1,158 | 🌐 C++ | 📅 2026-06-25 `#python` `#gtk4` `#libadwaita`.
* [Warpinator](https://github.com/linuxmint/warpinator) ⭐ 1,571 | 🐛 80 | 🌐 C | 📅 2026-05-18 - Linux Mint's LAN file sharing program `#c++` `#gtk3`.
* [Gabut Download Manager](https://github.com/gabutakut/gabutdm) ⭐ 154 | 🐛 4 | 🌐 Vala | 📅 2026-07-14 - Download manager supporting torrents and direct download with Firefox integration  `#vala` `#gtk4` `#libadwaita`.
...
* [Packet](https://flathub.org/en/apps/io.github.nozwock.Packet) - Application to send and receive files wirelessly with Android devices using Quick Share or another device with Packet installed `#rust` `#gtk4` `#libadwaita`.
* [Share](https://flathub.org/en/apps/io.github.sigmasd.share) - Simple file sharing application with drag-and-drop functionality, using QR codes `#gjs` `#typescript` `#gtk4` `#libadwaita`.
...
* [NM GUI](https://github.com/s-adi-dev/nmgui) ⭐ 265 | 🐛 8 | 🌐 Python | 📅 2025-10-30 - GUI for managing WiFi networks, using NetworkManager (`nmcli`) `#python` `#gtk4`.
* [Netsleuth](https://github.com/vmkspv/netsleuth) ⭐ 55 | 🐛 1 | 🌐 Python | 📅 2026-07-19 - Utility for the calculation and analysis of IP subnet values, designed to simplify network configuration tasks `#python` `#gtk4` `#libadwaita`.
...
* [Network Monitor](https://github.com/grigio/network-monitor) ⭐ 284 | 🐛 0 | 🌐 Rust | 📅 2026-08-10 - Real-time network connection monitoring tool with GUI & TUI `#rust` `#gtk4` `#libadwaita`.
* [Hotwire](https://github.com/emmanueltouzery/hotwire) ⭐ 243 | 🐛 3 | 🌐 Rust | 📅 2025-11-29 - GUI that leverages the wireshark and tshark infrastructure to capture traffic and explore the contents of tcpdump files `#rust` `#gtk3` `#relm`.
...
* [Pulp](https://flathub.org/en/apps/org.gnome.gitlab.cheywood.Pulp) - Application providing a workflow focused on reading through an excessive number of RSS feeds with the goal of regularly marking all read `#python` `#gtk4` `#libadwaita`.
...
* [Field Monitor](https://github.com/theCapypara/field-monitor) ⭐ 90 | 🐛 17 | 🌐 Rust | 📅 2026-08-10 - Remote desktop client for the GNOME desktop with support for Proxmox & QEMU/KVM virtual machines `#rust` `#gtk4` `#libadwaita`.
...
* [Fedinspect](https://flathub.org/en/apps/org.andypiper.Fedinspect) - Application for analysing Fediverse servers and user accounts `#python` `#gtk4` `#libadwaita`.
...
* [NewCaw](https://github.com/CodedOre/NewCaw) ⚠️ Archived - Used to be a Twitter client, rewrite to Mastodon API abandoned `#vala`.

### Specialized Web Browsers / Wrappers

* [Bavarder](https://github.com/Bavarder/Bavarder) ⭐ 268 | 🐛 6 | 🌐 Python | 📅 2026-08-08 - AI chatbot (ChatGPT, CatGPT, BAI Chat, Open-Assistant SFT-1 12B Model) interface `#python` `#gtk4` `#libadwaita`.
...
* [XCA AI Chat](https://flathub.org/en/apps/io.github.alfianlosari.GTKChatGPT) - AI chatbot interface for ChatOpenAI's ChatGPT `#swift` `#gtk4` `#libadwaita`.

### VPN

* [Haguichi](https://haguichi.net) - Graphical fronted for Hamachi `#vala` `#gtk4` `#libadwaita`.
* [Proton VPN](https://github.com/ProtonVPN/proton-vpn-gtk-app) ⭐ 721 | 🐛 69 | 🌐 Python | 📅 2026-08-10 - GTK fronted for Proton VPN `#python` `#gtk3`.

### Web Browsers

* [Add Water](https://flathub.org/en/apps/dev.qwery.AddWater) - Utility to install the [GNOME theme for Mozilla Firefox](https://github.com/rafaelmardojai/firefox-gnome-theme) ⭐ 3,895 | 🐛 52 | 🌐 CSS | 📅 2026-07-09 `#python`  `#gtk4` `#libadwaita`.
...
* [Linux Wifi Hotspot](https://github.com/lakinduakash/linux-wifi-hotspot) ⭐ 4,346 | 🐛 195 | 🌐 C | 📅 2026-02-25 - Feature-rich wifi hotspot creator for Linux which provides both GUI and command-line interface `#c` `#gtk3`.
...
* [Foliate](https://github.com/johnfactotum/foliate) ⭐ 8,627 | 🐛 308 | 🌐 JavaScript | 📅 2026-04-08 - Simple and modern eBook reader based on [Epub.js](https://github.com/futurepress/epub.js) ⭐ 6,941 | 🐛 517 | 🌐 JavaScript | 📅 2026-03-24 `#gjs` `#javascript` `#gtk4` `#libadwaita`.
...
* [NaSC](https://github.com/parnoldx/nasc) ⚠️ Archived - (archived, see [NaSCTUI](https://github.com/parnoldx/nascTUI) ⭐ 26 | 🐛 0 | 🌐 Go | 📅 2026-01-06) Dual pane text based calculator `#vala` `#gtk3` `#granite`.
...
* [Dippi](https://github.com/cassidyjames/dippi) ⭐ 91 | 🐛 11 | 🌐 Vala | 📅 2026-05-08 - Display DPI calculator `#vala` `#gtk4` `#libadwaita`.
* [Calculator](https://github.com/elementary/calculator) ⭐ 83 | 🐛 28 | 🌐 Vala | 📅 2026-07-25 - Calculator designed for elementary OS `#vala` `#gtk4` `#granite`.
...
* [Kairos](https://flathub.org/en/apps/io.gitlab.hinnerkm.Kairos) - Modern looking and intuitive calendar for desktop and mobile `#vala` `#gtk4` `#libadwaita`.
...
* [Xreader](https://github.com/linuxmint/xreader) ⭐ 282 | 🐛 242 | 🌐 C | 📅 2026-05-19 - Generic document viewer with support for PDF, Postscript, DjVu, comics and more `#c` `#gtk3` `#libxapp`.
* [Atril](https://github.com/mate-desktop/atril) ⭐ 247 | 🐛 186 | 🌐 C | 📅 2026-08-11 - Document viewer for the MATE desktop with support for PDF, PostScript (PS), Encapsulated PostScript (EPS), DJVU, DVI, and XPS (fork of Evince) `#c` `#gtk3`.
* [jumpdf](https://github.com/b43NnUNF4vidFYFhpqaLWy2ANawtRbMtUXZY9Pf/jumpdf) ⭐ 13 | 🐛 4 | 🌐 C | 📅 2026-03-13 - Keyboard-focused PDF viewer for documents where one needs to jump between different sections of the document frequently `#c` `#gtk4`.
...
* [CoBang](https://flathub.org/en/apps/vn.hoabinh.quan.CoBang) - QR Code and barcode scanner application `#python` `#gtk4` `#libadwaita`.
...
* [Rnote](https://github.com/flxzt/rnote) ⭐ 11,543 | 🐛 446 | 🌐 Rust | 📅 2026-07-28 - Vector-based drawing app for sketching, handwritten notes and to annotate documents and pictures with pressure-sensitive stylus input support `#rust` `#gtk4` `#libadwaita`.
* [Zim](https://github.com/zim-desktop-wiki/zim-desktop-wiki) ⭐ 2,193 | 🐛 441 | 🌐 Python | 📅 2026-07-26 - Text editor used to maintain a collection of wiki pages `#python` `#gtk3`.
* [Notekit](https://github.com/blackhole89/notekit) ⭐ 1,567 | 🐛 65 | 🌐 C++ | 📅 2026-01-29 - Hierarchical Markdown note-taking application with tablet support `#c++` `#gtk3`.
* [Notes-Up](https://github.com/Philip-Scott/Notes-up) ⭐ 632 | 🐛 81 | 🌐 Vala | 📅 2022-03-24 - Markdown note manager for elementary OS `#vala` `#gtk3` `#granite`.
* [Notejot](https://github.com/lainsce/notejot) ⭐ 415 | 🐛 0 | 🌐 Vala | 📅 2025-10-05 - Stupidly simple notes application `#vala` `#gtk4` `#libadwaita`.
* [Folio](https://github.com/toolstack/Folio) ⭐ 275 | 🐛 53 | 🌐 Vala | 📅 2026-04-17 - Markdown note-taking application with GNOME desktop integration (Paper fork with additional features) `#vala` `#gtk4` `#libadwaita`.
...
* [Notas](https://github.com/globalcve/Notas) ⭐ 7 | 🐛 0 | 🌐 Rust | 📅 2026-06-30 - Lightweight, encrypted note-taking application supporting AES-256-GCM encryption and Argon2 key derivation `#rust` `#gtk4` `#libadwaita`.
...
* [Journaler](https://github.com/phase1geo/journaler) ⭐ 7 | 🐛 1 | 🌐 Vala | 📅 2026-07-17 - Journaling application for elementary OS `#vala` `#gtk4` `#granite`.
...
* [gImageReader](https://github.com/manisandro/gImageReader) ⭐ 1,981 | 🐛 73 | 🌐 C++ | 📅 2026-01-15 - GTK/Qt front-end to [Tesseract] `#c++` `#gtk3`.
...
* [PDF Arranger](https://github.com/pdfarranger/pdfarranger) ⭐ 5,778 | 🐛 79 | 🌐 Python | 📅 2026-08-07 - PDF editor with merging, splitting, rotating, cropping and rearranging based on [pikepdf](https://github.com/pikepdf/pikepdf) ⭐ 2,785 | 🐛 23 | 🌐 Python | 📅 2026-08-06 `#python` `#gtk3` `#libhandy`.
...
* [Pympress](https://github.com/Cimbali/pympress) ⭐ 1,637 | 🐛 40 | 🌐 Python | 📅 2026-03-29 - Presentation tool designed for dual-screen setups such as presentations and public talks `#python` `#gtk3`.
* [Spice-up](https://github.com/Philip-Scott/Spice-up) ⭐ 605 | 🐛 51 | 🌐 Vala | 📅 2022-03-22 - Web presentation editor `#vala` `#gtk3` `#granite`.
* [Teleprompter](https://github.com/Nokse22/teleprompter) ⭐ 76 | 🐛 7 | 🌐 Python | 📅 2026-06-24 - Simple application to read scrolling text from your screen `#python` `#gtk4` `#libadwaita`.
...
* [lfy](https://flathub.org/en/apps/cool.ldr.lfy) - Translation application supporting Baidu, Tencent, Google Translate, Bing, Aliyun, Huoshan `#python` `#gtk4` `#libadwaita`.
...
* [Eloquent](https://flathub.org/en/apps/re.sonny.Eloquent) - Proofreading software for 20+ languages, powered by LanguageTool standalone server `#gjs` `#javascript` `#gtk4` `#libadwaita`.
* [Letters](https://flathub.org/en/apps/net.codelogistics.letters) - Modern, minimalist word processor for the GNOME desktop `#python` `#gtk4` `#libadwaita`.
* [WebkitWord](https://flathub.org/en/apps/io.github.fastrizwaan.WebkitWord) - Rich text editor with powerful word processing capabilities in a clutter-free modern interface `#python` `#gtk4` `#libadwaita`.
* [Scriptorium](https://flathub.org/en/apps/io.github.cgueret.Scriptorium) - Text editor coupled with a plotting and formatting tool to provide writers with an environment to plan, plot, write and edit e-books `#python` `#gtk4` `#libadwaita`.

## Productivity

### Desktop Productivity

* [Walker](https://github.com/abenz1267/walker) ⭐ 2,979 | 🐛 20 | 🌐 Rust | 📅 2026-07-23 - Customizable application launcher for Wayland `#rust` `#gtk4`.
* [StreamController](https://github.com/StreamController/StreamController) ⭐ 1,084 | 🐛 19 | 🌐 Python | 📅 2026-08-13 - Elgato Stream Deck controller with support for plugins `#python` `#gtk4` `#libadwaita`.
* [Szyszka](https://github.com/qarmin/szyszka) ⭐ 968 | 🐛 48 | 🌐 Rust | 📅 2026-06-06 - Fast bulk file renamer `#rust` `#gtk4`.
* [Sherlock](https://github.com/Skxxtz/sherlock) ⭐ 751 | 🐛 9 | 🌐 Rust | 📅 2026-04-25 - Application/command launcher for Wayland (with the Hyprland tiling window manager in mind) with async widgets and plugins `#rust` `#gtk4`.
...
* [Cigale](https://github.com/emmanueltouzery/cigale) ⭐ 85 | 🐛 1 | 🌐 Rust | 📅 2025-11-29 - Timesheet for your activities with support for emails, Git, GitLab and Stack Exchange `#rust` `#gtk3` `#relm`.
* [Workspaces](https://github.com/DevAlien/workspaces) ⭐ 77 | 🐛 24 | 🌐 Vala | 📅 2021-02-21 - Desktop workpaces for elementary OS `#vala` `#gtk3` `#granite`.
...
* [Onboard](https://github.com/dr-ni/onboard) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-08-05 - Alternative on screen keyboard (OSK) useful for everybody that cannot use a hardware keyboard, e.g. for mobile Linux or mobility impaired users `#python` `#gtk3`.
* [Actioneer](https://github.com/phase1geo/actioneer) ⭐ 1 | 🐛 0 | 🌐 Vala | 📅 2026-07-17 - Tool to automate actions on file changes `#vala` `#gtk3` `#granite`.
...
* [Clicker](https://flathub.org/en/apps/net.codelogistics.clicker) - Auto clicker application to simulate user input repeatedly `#python` `#gtk4` `#libadwaita`.
...
* [Wordbook](https://github.com/mufeedali/Wordbook) ⭐ 159 | 🐛 3 | 🌐 Python | 📅 2026-06-05 - Offline English-English dictionary application for the GNOME desktop using the Open English WordNet database and eSpeak for pronunciations `#python` `#gtk4` `#libadwaita` `#gnome`.
...
* [Minder](https://github.com/phase1geo/Minder) ⭐ 1,194 | 🐛 49 | 🌐 Vala | 📅 2026-07-20 - Mind-mapping application for elementary OS `#vala` `#gtk4` `#granite`.
...
* [Planify](https://github.com/alainm23/planify) ⭐ 5,578 | 🐛 166 | 🌐 Vala | 📅 2026-08-04 - Project and task manager with Todoist support `#vala` `#gtk4` `#libadwaita`.
* [Progress](https://flathub.org/en/apps/io.github.smolblackcat.Progress) - Simple kanban-style task organizer `#c++` `#gtk4` `#libadwaita`.
* [ThisWeekInMyLife (Schedule)](https://flathub.org/en/apps/io.github.zhrexl.thisweekinmylife) - Kanban-styled planner that aims to help organize a workflow and keep track of activities `#c` `#gtk4` `#libadwaita`.

### Timers / Time Tracking

* [Furtherance](https://github.com/lakoliu/Furtherance) ⭐ 396 | 🐛 6 | 🌐 Rust | 📅 2026-02-17 - Cross-platform time tracker `#rust` `#gtk4` `#libadwaita`.
* [Flowtime](https://github.com/Diego-Ivan/Flowtime) ⭐ 133 | 🐛 12 | 🌐 Vala | 📅 2025-04-28 - Pomodoro timer with statistics `#vala` `#gtk4` `#libadwaita`.
...
* [Play Timer (mpris-timer)](https://github.com/efogdev/mpris-timer) ⭐ 88 | 🐛 7 | 🌐 Go | 📅 2025-10-20 - Timer application that uses the MPRIS interface `#go` `#gtk4` `#libadwaita`.
* [Tomato](https://github.com/luizaugustomm/tomato) ⚠️ Archived - Pomodoro timer for elementary OS `#vala` `#gtk3` `#granite`.
* [Timer](https://github.com/vikdevelop/timer) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2026-07-01 - Simple countdown timer `#python` `#gtk4` `#libadwaita`.
* [Retro](https://github.com/sonnyp/Retro) ⭐ 37 | 🐛 6 | 🌐 JavaScript | 📅 2025-10-13 - Customizable digital clock `#gjs` `#javascript` `#gtk4` `#libadwaita`.
* [Hourglass](https://github.com/sgpthomas/hourglass) ⭐ 33 | 🐛 9 | 🌐 Vala | 📅 2026-06-22 - Simple time keeping application for elementary OS `#vala` `#gtk4` `#granite`.
...
* [Getting Things GNOME](https://github.com/getting-things-gnome/gtg) ⭐ 599 | 🐛 197 | 🌐 Python | 📅 2026-08-12 - Personal task organizer for the GNOME desktop inspired by [Getting Things Done](https://gettingthingsdone.com/what-is-gtd) `#python` `#gtk3`.
* [Effitask](https://github.com/sanpii/effitask) ⭐ 236 | 🐛 18 | 🌐 Rust | 📅 2026-07-16 - [todo.txt] client with due, flag, future note and schedule addons `#rust` `#gtk3` `#relm`.
* [Remembrance](https://github.com/dgsasha/remembrance) ⭐ 163 | 🐛 37 | 🌐 Python | 📅 2026-02-01 - Simple reminder app `#python` `#gtk4` `#libadwaita`.
* [IPlan](https://github.com/iman-salmani/iplan) ⭐ 135 | 🐛 28 | 🌐 Rust | 📅 2024-07-04 - Personal task manager with project-based task grouping, task timers and drag and drop arranging `#rust` `#gtk4` `#libadwaita`.
* [Agenda](https://github.com/dahenson/agenda) ⭐ 104 | 🐛 16 | 🌐 Vala | 📅 2026-05-20 - Simple to-do application for elementary OS `#vala` `#gtk3` `#granite`.
* [Tasks](https://github.com/elementary/tasks) ⭐ 85 | 🐛 53 | 🌐 Vala | 📅 2026-08-03 - Manager for tasks and reminders designed for elementary OS that support syncing via CalDAV `#vala` `#gtk4` `#libadwaita` `#libgranite`.
...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,444 | 🐛 20 | 🌐 Python | 📅 2026-08-12 - Virtual assistant (based on GPT4All) that interacts with the system by running shell commands and execute Python code `#python` `#gtk4` `#libadwaita`.

## Academia and Research

### Chemistry

* [Nucleus](https://flathub.org/en/apps/page.codeberg.lo_vely.Nucleus) - Periodic table of the elements viewer that lets you explore the properties of each element `#python` `#gtk4` `#libadwaita`.
...
* [LogicRs](https://github.com/Spydr06/logicrs) ⭐ 67 | 🐛 11 | 🌐 Rust | 📅 2025-10-12 - Logical circuits simulator/editor `#rust` `#gtk4` `#libadwaita`.
...
* [NOAA APT](https://github.com/bareboat-necessities/noaa-apt) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-02-10 - Weather satellite image decoder `#rust` `#gtk3`.
...
* [balistica](https://github.com/fusilero/balistica) ⭐ 67 | 🐛 9 | 🌐 Vala | 📅 2026-07-29 - Exterior ballistics calculator `#vala` `#gtk3`.
* [AstraLite](https://github.com/art-den/astra_lite) ⭐ 53 | 🐛 7 | 🌐 Rust | 📅 2026-08-05 - Software for deepsky astrophotography and live stacking `#rust` `#gtk3`.
...
* [Navier Stokes Spectral Method](https://github.com/Minard-Jules/Navier_Stokes_Spectral_Method) ⭐ 4 | 🐛 0 | 🌐 Fortran | 📅 2026-06-14 - Numerical simulation of the 2D Navier-Stokes equations in the ω − ψ formulation using the pseudo-spectral method `#fortran` `#gtk4`.
...
* [OTPClient](https://github.com/paolostivanin/OTPClient) ⭐ 557 | 🐛 2 | 🌐 C | 📅 2026-08-04 - One Time Password application that supports both TOTP and HOTP `#c` `#gtk4` `#libadwaita`.
* [Gonepass](https://github.com/jbreams/gonepass) ⭐ 130 | 🐛 13 | 🌐 C++ | 📅 2018-12-21 - 1Password vault reader `#c++` `#gtk3`.
* [Obliviate](https://github.com/elfenware/obliviate) ⭐ 26 | 🐛 1 | 🌐 Vala | 📅 2026-01-08 - Password manager that does not store passwords for elementary OS `#vala` `#gtk3` `#granite` `#libhandy`.
...
* [Hashes](https://github.com/zefr0x/hashes) ⭐ 30 | 🐛 1 | 🌐 Python | 📅 2026-06-12 - Identify hashing algorithms `#python` `#gtk4` `#libadwaita`.
...
* [HomeBank](https://www.gethomebank.org) - Cross-platform personal accounting application with dynamic reports and import from QIF, OFX, QFX, and CSV `#c` `#gtk3`.
...
* [Markets](https://github.com/bitstower/markets) ⚠️ Archived - Stock, currency and cryptocurrency tracker `#vala` `#gtk3` `#libhandy`.
...
* [WineCharm](https://github.com/fastrizwaan/WineCharm) ⭐ 30 | 🐛 0 | 🌐 Python | 📅 2026-08-04 - GUI designed to simplify running and managing Windows applications on Linux using Wine `#python` `#gtk4` `#libadwaita`.
* [WineZGUI](https://flathub.org/en/apps/io.github.fastrizwaan.WineZGUI) - Zenity GUI for managing Wine prefixes and launching Windows binaries through Wine `#python` `#gtk4` `#libadwaita`.

## Development

### Containers

* [Virtual Machine Manager (virt-manager)](https://github.com/virt-manager/virt-manager) ⭐ 3,229 | 🐛 157 | 🌐 Python | 📅 2026-07-20 - Graphical tool for managing virtual machines such as QEMU/KVM, Xen, LXC `#python` `#gtk3`.
* [Pods](https://github.com/marhkb/pods) ⭐ 1,076 | 🐛 39 | 🌐 Rust | 📅 2026-07-23 - Podman containers manager `#rust` `#gtk4` `#libadwaita`.
* [BoxBuddy](https://github.com/Dvlv/BoxBuddyRS) ⭐ 549 | 🐛 10 | 🌐 Rust | 📅 2026-05-28 - Graphical interface for Distrobox `#rust` `#gtk4` `#libadwaita`.
* [Atoms](https://github.com/AtomsDevs/Atoms) ⭐ 439 | 🐛 22 | 🌐 Python | 📅 2024-06-07 - Linux Chroot environments manager `#python` `#gtk4` `#libadwaita`.
...
* [Seabird](https://flathub.org/en/apps/dev.skynomads.Seabird) - Cross-platform Kubernetes IDE for the GNOME desktop, e.g. to explore and manage clusters `#go` `#gtk4` `#libadwaita`.

### Development Tools

* [D-Spy](https://flathub.org/en/apps/org.gnome.dspy) - Simple tool to explore D-Bus connections `#c` `#gtk4` `#libadwaita` `#gnome`.
* [FlyCrys](https://github.com/SergKam/FlyCrys) ⭐ 30 | 🐛 0 | 🌐 Rust | 📅 2026-06-25 - Native GUI for Claude Code AI agents with file tree, text viewer, embedded terminal, and multi-workspace support `#rust` `#gtk4`.
...
* [DevDocs Desktop](https://github.com/hardpixel/devdocs-desktop) ⭐ 126 | 🐛 3 | 🌐 Python | 📅 2023-04-30 - [DevDocs] browser and viewer `#python` `#gtk3`.
* [quickDocs](https://github.com/mdh34/quickDocs) ⚠️ Archived - Documentation browser for [DevDocs] and Valadoc `#vala` `#gtk3` `#granite`.
...
* [Learn 6502 Assembly](https://flathub.org/en/apps/eu.jumplink.Learn6502) - Complete learning environment for programming vintage computers and game consoles, incl. tutorial, dedicated editor and debugger, virtual game console `#gjs` `#typescript` `#gtk4` `#libadwaita`.
...
* [Valama](https://github.com/Valama/valama) ⭐ 204 | 🐛 77 | 🌐 Vala | 📅 2022-11-30 - Vala IDE `#vala` `#gtk3`.
* [Playhouse](https://github.com/sonnyp/Playhouse) ⭐ 172 | 🐛 9 | 🌐 JavaScript | 📅 2025-12-18 - Playground for HTML/CSS/JavaScript `#gjs` `#javascript` `#gtk4` `#libadwaita`.
* [GtkIDE.jl](https://github.com/jonathanBieler/GtkIDE.jl) ⭐ 74 | 🐛 6 | 🌐 Julia | 📅 2021-09-29 - GTK-based IDE for Julia `#julia` `#gtk3`.
...
* [GNvim](https://github.com/vhakulinen/gnvim) ⭐ 1,954 | 🐛 10 | 🌐 Rust | 📅 2026-06-28 - GUI for Neovim without any web bloat `#rust` `#gtk4` `#libadwaita`.
* [neovim-gtk](https://github.com/Lyude/neovim-gtk) ⭐ 175 | 🐛 52 | 🌐 Rust | 📅 2026-06-28 - GUI for Neovim with ligatures support `#rust` `#gtk4`.
...
* [Xed](https://github.com/linuxmint/xed) ⭐ 549 | 🐛 258 | 🌐 C | 📅 2026-02-11 - Small and lightweight text editor `#c` `#gtk3` `#libxapp`.
* [elementary Code](https://github.com/elementary/code) ⭐ 518 | 🐛 167 | 🌐 Vala | 📅 2026-08-13 - Code editor designed for elementary OS `#vala` `#gtk3` `#granite` `#elementary`.
* [Pluma](https://github.com/mate-desktop/pluma) ⭐ 189 | 🐛 119 | 🌐 C | 📅 2026-06-29 - Text editor for the MATE desktop `#c` `#gtk3`.
...
* [Slate](https://github.com/wpkelso/slate) ⭐ 2 | 🐛 9 | 🌐 Vala | 📅 2026-08-11 - Simple text editor designed for elementary OS `#vala` `#gtk4` `#granite`.
...
* [Marker](https://github.com/fabiocolacio/Marker) ⭐ 864 | 🐛 138 | 🌐 JavaScript | 📅 2026-03-04 - Markdown editor with HTML and LaTeX conversion with [scidown](https://github.com/Mandarancio/scidown) ⭐ 55 | 🐛 6 | 🌐 C | 📅 2019-11-06 `#c` `#gtk3`.
* [Quilter](https://github.com/lainsce/quilter) ⭐ 295 | 🐛 0 | 🌐 Vala | 📅 2026-08-12 - Distraction-free Markdown editor `#vala` `#gtk4` `#libadwaita`.
...
* [Tabëla](https://flathub.org/en/apps/com.mastropaolo.www.tabela) - Utility to format tables to Markdown or HTML `#rust` `#gtk4` `#libadwaita`.

### LaTeX

* [Bada Bib!](https://flathub.org/en/apps/com.github.rogercrocker.badabib) - BibTex viewer and editor `#python` `#gtk4` `#libadwaita`.
...
* [TeX Match](https://github.com/zoeyfyi/TeX-Match) ⭐ 160 | 🐛 15 | 🌐 C# | 📅 2023-01-06 - Cross-platform application to search for LaTeX symbols by sketching `#rust` `#gtk3`.

### Typst

* [Escritoire](https://flathub.org/en/apps/page.codeberg.dudenix.escritoire) - Application to write standard-compliant letter using Typst `#rust` `#gtk4` `#libadwaita`.
* [Typewriter](https://flathub.org/en/apps/app.drey.Typewriter) - Simple Typst editor `#rust` `#gtk4` `#libadwaita`.
* [Typesetter](https://codeberg.org/haydn/typesetter) - Simple local-first Typst editor with automatic preview `#rust` `#gtk4` `#libadwaita`.
...
* [Guake](https://github.com/Guake/guake) ⭐ 4,666 | 🐛 460 | 🌐 Python | 📅 2026-07-04 - Dropdown terminal for the GNOME desktop `#python` `#gtk3`.
...
* [KonbuCase](https://github.com/ryonakano/konbucase) ⭐ 14 | 🐛 5 | 🌐 Vala | 📅 2026-08-13 - Case converting application `#vala` `#gtk4` `#libadwaita`.
...
* [Dev Toolbox](https://github.com/aleiepure/devtoolbox) ⭐ 481 | 🐛 46 | 🌐 Python | 📅 2026-07-04 - Developer toolbox with JSON to YAML converter, CRON expressions parser, language formatter, hash generators, regex tester, Markdown preview, image converters and more `#python` `#gtk4` `#libadwaita`.
* [Escambo](https://github.com/CleoMenezesJr/escambo) ⭐ 145 | 🐛 19 | 🌐 Python | 📅 2024-05-01 - HTTP-based APIs test application `#python` `#gtk4` `#libadwaita`.
...
* [Digger](https://flathub.org/en/apps/io.github.tobagin.digger) - DNS lookup tool, user interface for the dig command `#python` `#gtk4` `#libadwaita`.
...
* [Gradience](https://github.com/GradienceTeam/Gradience) ⚠️ Archived - Libadwaita applications customizer `#python` `#gtk4` `#libadwaita`.
...
* [Diffuse](https://github.com/MightyCreak/diffuse) ⭐ 331 | 🐛 47 | 🌐 Python | 📅 2026-03-13 - Text file comparing/merging tool `#python` `#gtk3`.
* [Gnomit](https://github.com/small-tech/gnomit) ⚠️ Archived - (archived) Git commit message editor for the GNOME desktop `#gjs` `#javascript` `#gtk3`.
...
* [Text Compare](https://flathub.org/en/apps/io.github.josephmawa.TextCompare) - Simple text comparison application to compare old and new text `#gjs` `#javascript` `#gtk4` `#libadwaita`.
...
* [Flexa](https://github.com/EuCaue/Flexa) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-07-22 - Convert cursor themes between Windows and Linux formats `#python` `#gtk4` `#libadwaita`.
...
* [Iconic](https://flathub.org/en/apps/nl.emphisia.icon) - Application to create folder icons and add them on top of folders in GNOME `#rust` `#gtk4` `#libadwaita`.
...
* [Timeshift](https://github.com/linuxmint/timeshift) ⭐ 4,227 | 🐛 234 | 🌐 Vala | 📅 2026-04-08 - System restore tool for Linux that creates filesystem snapshots using rsync or Btrfs snapshots `#vala` `#gtk3`.
...
* [Sequeler](https://github.com/Alecaddd/sequeler) ⭐ 841 | 🐛 69 | 🌐 Vala | 📅 2026-07-03 - SQL client with support for PostgreSQL, MariaDB and SQLite `#vala` `#gtk3` `#granite`.
...
* [Popsicle](https://github.com/pop-os/popsicle) ⭐ 848 | 🐛 29 | 🌐 Rust | 📅 2026-07-29 - Utility for flashing multiple USB devices in parallel `#rust` `#gtk3`.
...
* [Nemo](https://github.com/linuxmint/nemo) ⭐ 1,546 | 🐛 325 | 🌐 C | 📅 2026-08-12 - Default file manager of the Cinnamon desktop (fork of Nautilus) `#c` `#gtk3`.
* [Files (elementary)](https://github.com/elementary/files) ⭐ 365 | 🐛 315 | 🌐 Vala | 📅 2026-08-03 - File browser for elementary OS `#vala` `#gtk3` `#libhandy` `#granite`.
* [Caja](https://github.com/mate-desktop/caja) ⭐ 317 | 🐛 501 | 🌐 C | 📅 2026-07-30 - File manager for the MATE desktop  `#c` `#gtk3`.
* [Hyperplane](https://github.com/kra-mo/hyperplane) ⭐ 258 | 🐛 3 | 🌐 Python | 📅 2026-03-18 - Non-hierarchical file manager `#python` `#gtk4` `#libadwaita`.
* [PCManFM](https://github.com/lxde/pcmanfm) ⭐ 248 | 🐛 33 | 🌐 C | 📅 2026-02-03 - Lightweight file manager, standard file manager for LXDE `#c` `#gtk3`.
* [fm](https://github.com/euclio/fm) ⭐ 247 | 🐛 47 | 🌐 Rust | 📅 2025-03-23 - Small, general purpose file manager `#rust` `#gtk4` `#libadwaita`.
...
* [FSearch](https://github.com/cboxdoerfer/fsearch) ⭐ 4,300 | 🐛 170 | 🌐 C | 📅 2026-08-06 - A fast file search utility `#c` `#gtk3`.
...
* [Syncthing-GTK](https://github.com/syncthing/syncthing-gtk) ⭐ 1,398 | 🐛 97 | 🌐 Python | 📅 2023-04-24 - UI for [Syncthing](https://syncthing.net) with the same features as the Web UI `#python` `#gtk3`.
...
* [Taxi](https://github.com/Alecaddd/taxi) ⭐ 104 | 🐛 23 | 🌐 Vala | 📅 2025-06-30 - FTP client designed for elementary OS that also supports SFTP, WebDAV and AFP `#vala` `#gtk4` `#granite` `#libadwaita`.
...
* [ProtonPlus](https://github.com/Vysp3r/ProtonPlus) ⭐ 1,702 | 🐛 19 | 🌐 Vala | 📅 2026-08-13 - Proton version manager `#vala` `#gtk4` `#libadwaita`.
* [Extension Manager](https://github.com/mjakeman/extension-manager) ⭐ 1,352 | 🐛 28 | 🌐 C | 📅 2026-08-13 - Utility for browsing and installing GNOME Shell Extensions `#c` `#gtk4` `#libadwaita`.
* [Shelly](https://github.com/Seafoam-Labs/Shelly-ALPM) ⭐ 1,006 | 🐛 41 | 🌐 Zig | 📅 2026-08-13 - Package manager for Arch Linux, CachyOS supporting AUR, Flathub, Flatpak, AppImage, and native Arch Linux packages `#zig` `#gtk4`.
* [Nix Software Center](https://github.com/snowfallorg/nix-software-center) ⭐ 841 | 🐛 59 | 🌐 Rust | 📅 2026-04-07 - Software center to easity install and manage Nix packages `#rust` `#gtk4` `#libadwaita` `#relm4`.
* [AdwSteamGtk](https://github.com/Foldex/AdwSteamGtk) ⭐ 385 | 🐛 6 | 🌐 Python | 📅 2026-04-10 - [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) ⭐ 1,579 | 🐛 13 | 🌐 CSS | 📅 2026-08-02 skin installer `#python` `#gtk4` `#libadwaita`.
* [Icicle](https://github.com/snowfallorg/icicle) ⭐ 106 | 🐛 9 | 🌐 Rust | 📅 2026-08-02 - Graphical installer for NixOS based distributions `#rust` `#gtk4` `#libadwaita` `#relm4`.
* [Pin It!](https://github.com/ryonakano/pinit) ⭐ 81 | 🐛 13 | 🌐 Vala | 📅 2026-07-28 - Portable applications shortcut creator `#vala` `#gtk4` `#libadwaita`.
...
* [GNOME Firmware](https://flathub.org/en/apps/org.gnome.Firmware) - Utility for updating, reinstalling and downgrading of firmware on devices supported by fwupd  `#c` `#gtk4` `#libadwaita` `#gnome`.
...
* [Czkawka](https://github.com/qarmin/czkawka) ⭐ 32,676 | 🐛 300 | 🌐 Fluent | 📅 2026-07-29 - Cross-platform, simple and fast application to remove unnecessary files from your computer `#rust` `#gtk4`.
* [Detwinner](https://neatdecisions.com/products/detwinner-linux) - Duplicate file finder `#c++` `#gtk3`.

### System Configuration

* [Solaar](https://github.com/pwr-Solaar/Solaar) ⭐ 9,137 | 🐛 84 | 🌐 Python | 📅 2026-07-31 - Manager for many Logitech keyboards, mice, and other devices that connect wirelessly to a Unifying, Bolt, Lightspeed or Nano receiver, USB cable or Bluetooth `#python` `#gtk3`.
* [LACT](https://github.com/ilya-zlobintsev/LACT) ⭐ 5,326 | 🐛 88 | 🌐 Rust | 📅 2026-08-12 - Application to control AMD, Nvidia or Intel graphical processing units (GPU) on Linux `#rust` `#gtk4` `#libadwaita`.
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 5,121 | 🐛 127 | 🌐 Rust | 📅 2026-06-28 - Mouse and keyboard sharing software (software KVM switch) designed for Wayland `#rust` `#gtk4` `#libadwaita`.
* [Hidamari](https://github.com/jeffshee/hidamari) ⭐ 2,080 | 🐛 128 | 🌐 Python | 📅 2026-07-09 - Application to configure video wallpaper for X11 and Wayland `#python` `#gtk3`.
* [Flatseal](https://github.com/tchx84/Flatseal) ⭐ 1,744 | 🐛 97 | 🌐 JavaScript | 📅 2026-08-10 - Flatpak permission manager `#gjs` `#javascript` `#gtk4` `#libadwaita`.
* [SaveDesktop](https://github.com/vikdevelop/SaveDesktop) ⭐ 798 | 🐛 0 | 🌐 Python | 📅 2026-08-08 - Plasma, Xfce and GNOME-based DE configuration saver (icons, fonts, themes, settings, background, GNOME extensions, Flatpak permissions and more) `#python` `#gtk4` `#libadwaita`.
* [ReGreet](https://github.com/rharish101/ReGreet) ⭐ 795 | 🐛 27 | 🌐 Rust | 📅 2026-07-17 - GTK-based [greetd](https://git.sr.ht/~kennylevinsen/greetd) greeter `#rust` `#gtk4` `#relm4`.
* [NixOS Configuration Editor](https://github.com/vlinkz/nixos-conf-editor) ⭐ 676 | 🐛 14 | 🌐 Rust | 📅 2026-02-15 - Application for editing NixOS configurations `#rust` `#gtk4` `#libadwaita` `#relm4`.
* [Warehouse](https://github.com/flattool/warehouse) ⭐ 619 | 🐛 70 | 🌐 Python | 📅 2026-07-22 - Toolbox for managing Flatpak packages (view info, manage user data, pin versions, change version, install/uninstall, etc.) `#python` `#gtk4` `#libadwaita`.
* [EasySSH](https://github.com/muriloventuroso/easyssh) ⭐ 552 | 🐛 55 | 🌐 Vala | 📅 2026-07-12 - SSH connection manager `#vala` `#gtk3`.
* [Luminance](https://github.com/sidevesh/Luminance) ⭐ 177 | 🐛 10 | 🌐 C | 📅 2026-08-09 - Simple application to control brightness of displays (including external) supporting DDC/CI `#c` `#gtk4` `#libadwaita`.
* [Dynamic Wallpaper](https://github.com/dusansimic/dynamic-wallpaper) ⭐ 155 | 🐛 21 | 🌐 Python | 📅 2024-11-09 - Dynamic wallpaper creator for GNOME 42 `#python` `#gtk4` `#libadwaita`.
* [Embellish](https://github.com/getnf/embellish) ⭐ 64 | 🐛 0 | 🌐 Vala | 📅 2026-08-03 - Application to install and manage Nerd Fonts on the system `#gjs` `#javascript` `#gtk4` `#libadwaita`.
* [Wardrobe](https://github.com/SwordPuffin/Wardrobe) ⭐ 34 | 🐛 3 | 🌐 Python | 📅 2026-06-19 - Utility to download GNOME shell extensions and GTK themes and icon packs `#python` `#gtk4` `#libadwaita`.
...
* [Picture of the Day](https://flathub.org/en/apps/de.swsnr.pictureoftheday) -  Application to set a daily wallpaper, from different sources (NASA Astronomy Picture of the Day, Bing, Wikimedia, Simon Stålenhag artwork) `#rust` `#gtk4` `#libadwaita`.
...
* [SSH Pilot](https://sshpilot.app) - SSH connection manager with integrated terminal and SFTP client `#python` `#gtk4`  `#libadwaita`.
...
* [Monitor](https://github.com/stsdc/monitor) ⭐ 361 | 🐛 36 | 🌐 Vala | 📅 2026-08-01 - Manage processes and monitor system resources `#vala` `#gtk4` `#libadwaita` `#granite`.
* [Packetry](https://github.com/greatscottgadgets/packetry) ⭐ 280 | 🐛 17 | 🌐 Rust | 📅 2026-08-12 - USB 2.0 protocol analysis application for use with the hardware device Cynthion `#rust` `#gtk4`.
...
* [Stimulator](https://github.com/sigmaSd/stimulator) ⭐ 41 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-06 - Application to keep the computer awake with AppIndicator support `#gjs` `#typescript` `#gtk4` `#libadwaita`.
...
* [Time Switch](https://github.com/fsobolev/timeswitch) ⚠️ Archived - Computer shutdown timer `#python` `#gtk4` `#libadwaita`.
...
* [DeSmuME](https://github.com/TASEmulators/desmume) ⭐ 3,610 | 🐛 92 | 🌐 C++ | 📅 2026-08-11 - Cross-platform Nintendo DS emulator `#c++` `#gtk3`.
* [An Anime Game launcher](https://github.com/an-anime-team/an-anime-game-launcher) ⭐ 2,201 | 🐛 109 | 🌐 Fluent | 📅 2026-07-23 - Genshin Impact launcher for Linux with telemetry disabling `#rust` `#gtk4` `#relm4` `#libadwaita`.
* [Cartridges](https://github.com/kra-mo/cartridges) ⭐ 828 | 🐛 29 | 🌐 Python | 📅 2026-08-07 - Game launcher with Steam, Lutris, Heroic, Legendary, Bottles, itch and RetroArch library import `#python` `#gtk4` `#libadwaita`.
* [Epic Asset Manager](https://github.com/AchetaGames/Epic-Asset-Manager) ⭐ 520 | 🐛 91 | 🌐 Rust | 📅 2026-03-23 - Unofficial client to install Unreal Engine, download and manage purchased assets, projects, plugins and games from the Epic Games Store `#rust` `#gtk4` `#libadwaita`.
* [Keypunch](https://github.com/bragefuglseth/keypunch) ⭐ 282 | 🐛 20 | 🌐 Rust | 📅 2026-08-07 - Keyboard typing test like monkeytype `#rust` `#gtk4` `#libadwaita` `#gnome`.
* [Gameeky](https://github.com/tchx84/gameeky) ⭐ 139 | 🐛 15 | 🌐 Python | 📅 2025-10-13 - Application to create and play games without any code for young learners and educators `#python` `#gtk4` `#libadwaita`.
...
* [Maniatic Launcher](https://flathub.org/en/apps/io.github.santiagocezar.maniatic-launcher) - Launcher for the decompilation of Sonic Manic Plus (Retro Engine v5) `#python` `#gtk4` `#libadwaita`.
...
* [Ultimate Tic Tac Toe](https://github.com/Nokse22/ultimate-tic-tac-toe) ⭐ 28 | 🐛 3 | 🌐 Python | 📅 2025-10-18 - [Ultimate Tic Tac Toe](https://en.wikipedia.org/wiki/Ultimate_tic-tac-toe) to play with friends or against an AI `#python` `#gtk4` `#libadwaita`.
* [Rollit](https://github.com/ellie-commons/rollit) ⭐ 1 | 🐛 1 | 🌐 Vala | 📅 2026-01-14 - Roll the dice application from six-sided dice up to 999 sides, designed for elementary OS `#vala` `#gtk4` `#granite`.
...
* [Flood It](https://flathub.org/en/apps/io.github.tfuxu.floodit) - Game with the simple premise of flooding the entire board with one color in the least amount of moves possible `#go` `#gtk4` `#libadwaita`.
...
* [Trivia Quiz](https://github.com/Nokse22/trivia-quiz) ⭐ 20 | 🐛 2 | 🌐 Python | 📅 2026-06-24 - Trivia game using questions from the Open Trivia database `#python` `#gtk4` `#libadwaita`.
...
* [Game of Life](https://flathub.org/en/apps/com.github.sixpounder.GameOfLife) - Simple Conway's game of life simulator for the GNOME desktop  `#rust` `#gtk4` `#libadwaita`.
...
* [Freeciv GTK Client](https://flathub.org/en/apps/org.freeciv.gtk4) - Empire-building strategy game inspired by the history of human civilization `#c` `#gtk4`.

## Health and Fitness

* [Dosage](https://github.com/diegopvlk/Dosage) ⭐ 154 | 🐛 9 | 🌐 JavaScript | 📅 2026-08-06 - Medication tracker `#gjs` `#javascript` `#gtk4` `#libadwaita`.
* [BLE Sync Cycle](https://github.com/richbl/go-ble-sync-cycle) ⭐ 28 | 🐛 5 | 🌐 Go | 📅 2026-07-12 - Indoor cycling application synchronizing video playback with real-time cycling data from Bluetooth Low Energy (BLE) devices `#go` `#gtk4` `#libadwaita`.
* [BMI](https://github.com/PhilippKosarev/bmi) ⭐ 8 | 🐛 1 | 🌐 Python | 📅 2026-08-07 - Body mass index (BMI) calculator with advanced mode for Waist-Height Ratio, Waist-Hip ratio and BRI `#python` `#gtk4` `#libadwaita`.
...
* [Maps](https://github.com/elementary/maps) ⭐ 24 | 🐛 12 | 🌐 Vala | 📅 2026-08-03 - Map viewer designed for elementary OS `#vala` `#gtk4` `#granite` `#libadwaita`.

## Public Transports

* [Passes](https://flathub.org/en/apps/me.sanchezrodriguez.passes) - Application to manage digital passes in PKPass or esPass format, such as boarding passes, bus tickets, coupons, loyalty cards, event tickets, etc. `#python` `#gtk4` `#libadwaita`.
...
* [Mousam](https://github.com/amit9838/mousam) ⭐ 475 | 🐛 40 | 🌐 Python | 📅 2026-08-04 - Lightweight weather application with dynamically changing gradient-based background according to current weather condition `#python` `#gtk4` `#libadwaita`.
* [Nimbus](https://github.com/danrabbit/nimbus) ⭐ 83 | 🐛 14 | 🌐 Vala | 📅 2024-09-05 - Minimal weather applet `#vala` `#gtk4` `#granite`.
* [Emergency alerts](https://github.com/leolost2605/emergency-alerts) ⭐ 24 | 🐛 21 | 🌐 Vala | 📅 2026-08-09 - Simple application that sends emergency alerts about the specified location `#vala` `#gtk4` `#granite`.
...
* [Butler](https://github.com/cassidyjames/butler) ⭐ 212 | 🐛 25 | 🌐 Vala | 📅 2026-05-27 - Native UI wrapper for the Home Assistant dashboard `#vala` `#gtk4` `#libadwaita`.
...
* [Fidei](https://github.com/sp1ritCS/fidei) ⭐ 9 | 🐛 2 | 🌐 C | 📅 2025-04-20 - Bible reader for the GNOME desktop `#c` `#gtk4` `#libadwaita`.
