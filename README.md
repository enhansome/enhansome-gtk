...
* [Quod Libet](https://github.com/quodlibet/quodlibet) ⭐ 1,752 | 🐛 890 | 🌐 Python | 📅 2026-09-13 - Cross-platform audio player providing many different ways to view local libraries `#python` `#gtk3`.
...
* [Riff](https://github.com/Diegovsky/riff) ⭐ 295 | 🐛 27 | 🌐 Rust | 📅 2026-09-11 - Spotify (premium) client for the GNOME desktop with MPRIS integration based on [librespot](https://github.com/librespot-org/librespot) ⭐ 7,137 | 🐛 137 | 🌐 Rust | 📅 2026-09-11, fork of [Spot](https://github.com/xou816/spot) ⭐ 2,369 | 🐛 114 | 🌐 Rust | 📅 2025-10-13 `#rust` `#gtk4` `#libadwaita`.
...
* [Euphonica](https://github.com/htkhiem/euphonica) ⭐ 882 | 🐛 65 | 🌐 Rust | 📅 2026-09-13 - Feature-packed MPD client with MPIRS support, customisable spectrum visualiser, dBFS readout support and more `#rust` `#gtk4` `#libadwaita`.
...
* [zrythm](https://github.com/zrythm/zrythm) ⭐ 3,118 | 🐛 2 | 🌐 C++ | 📅 2026-09-10 - DAW offering streamlined editing workflows with automation capabilities, chord assistance and support for plugins `#c++` `#gtk4` `#libadwaita`.

### Audio Tools

* [SongRec](https://github.com/marin-m/SongRec) ⭐ 1,961 | 🐛 70 | 🌐 Rust | 📅 2026-09-05 - Shazam GUI client `#rust` `#gtk3`.
...
* [Drum Machine](https://github.com/Revisto/drum-machine) ⭐ 151 | 🐛 21 | 🌐 Python | 📅 2026-09-13 - Drum machine application to create and play drum beats `#python` `#gtk4` `#libadwaita` `#gnome`.
...
* [Celluloid](https://github.com/celluloid-player/celluloid) ⭐ 1,464 | 🐛 290 | 🌐 C | 📅 2026-08-29 - (ex GNOME MPV) frontend for MPV `#c` `#gtk4` `#libadwaita`.
* [Clapper](https://github.com/Rafostar/clapper) ⭐ 972 | 🐛 134 | 🌐 C | 📅 2026-07-20 - Media player powered by GStreamer with OpenGL rendering `#c` `#gtk4` `#libadwaita`.
...
* [Kooha](https://github.com/SeaDve/Kooha) ⭐ 3,506 | 🐛 100 | 🌐 Rust | 📅 2026-09-07 - Distraction-free screen recorder `#rust` `#gtk4` `#libadwaita`.
...
* [Pix](https://github.com/linuxmint/pix) ⭐ 269 | 🐛 120 | 🌐 C | 📅 2026-04-08 - Image viewer and browser `#c` `#gtk3` `#libxapp`.
* [Vipsdisp](https://github.com/jcupitt/vipsdisp) ⭐ 236 | 🐛 10 | 🌐 C | 📅 2026-09-13 - Image viewer capable of displaying huge (i.e. GB sizes) images based on [`libvips`](https://github.com/libvips/libvips) ⭐ 11,636 | 🐛 80 | 🌐 C | 📅 2026-09-13 and supporting many scientific and technical image formats `#c` `#gtk4`.
* [Fotema](https://github.com/blissd/fotema) ⭐ 196 | 🐛 71 | 🌐 Rust | 📅 2026-09-12 - Photo gallery with support for iOS Live Photos and Android motion photos `#rust` `#gtk4` `#libadwaita` `#relm4`.
...
* [nip4](https://github.com/jcupitt/nip4) ⭐ 97 | 🐛 3 | 🌐 C | 📅 2026-09-13 - Spreadsheet-like GUI for the vips8 image processing library. `#c` `#gtk4`.
...
* [Upscaler](https://gitlab.com/TheEvilSkeleton/Upscaler) - Image upscaler based on [Real-ESRGAN ncnn Vulkan](https://github.com/xinntao/Real-ESRGAN-ncnn-vulkan) ⭐ 2,227 | 🐛 67 | 🌐 C | 📅 2024-05-10 `#python` `#gtk4` `#libadwaita`.

### Technical Graphics

* [Horizon](https://github.com/horizon-eda/horizon) ⭐ 1,316 | 🐛 166 | 🌐 C | 📅 2026-09-10 - EDA package supporting an integrated end-to-end workflow for printed circuit design `#c++` `#gtk3`.
...
* [Parabolic](https://github.com/NickvisionApps/Parabolic) ⭐ 7,049 | 🐛 97 | 🌐 C# | 📅 2026-06-29 - [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 190,852 | 🐛 2,648 | 🌐 Python | 📅 2026-08-30 graphical fronted `#csharp` `#gtk4` `#libadwaita`.
* [Gydl](https://github.com/JannikHv/gydl) ⭐ 156 | 🐛 16 | 🌐 Python | 📅 2025-11-28 - GUI wrapper around [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,211 | 🐛 4,125 | 🌐 Python | 📅 2026-02-19 `#python` `#gtk3`.
...
* [Overskride](https://github.com/kaii-lb/overskride) ⭐ 910 | 🐛 20 | 🌐 Rust | 📅 2026-09-01 - Bluetooth and Obex client/device manager `#rust` `#gtk4` `#libadwaita`.
...
* [Vireo](https://github.com/hyprlab/vireo) ⭐ 62 | 🐛 3 | 🌐 Rust | 📅 2026-09-13 - Email client for the GNOME desktop that aims to be privacy-first, fast with a clean interface `#rust` `#gtk4` `#libadwaita`.
...
* [Varia](https://github.com/giantpinkrobots/varia) ⭐ 1,859 | 🐛 58 | 🌐 Python | 📅 2026-09-04 - Download manager based on [aria2](https://github.com/aria2/aria2) ⭐ 42,210 | 🐛 1,177 | 🌐 C++ | 📅 2026-06-25 `#python` `#gtk4` `#libadwaita`.
...
* [Field Monitor](https://github.com/theCapypara/field-monitor) ⭐ 94 | 🐛 20 | 🌐 Rust | 📅 2026-09-12 - Remote desktop client for the GNOME desktop with support for Proxmox & QEMU/KVM virtual machines `#rust` `#gtk4` `#libadwaita`.
...
* [Proton VPN](https://github.com/ProtonVPN/proton-vpn-gtk-app) ⭐ 754 | 🐛 81 | 🌐 Python | 📅 2026-08-31 - GTK fronted for Proton VPN `#python` `#gtk3`.
...
* [Foliate](https://github.com/johnfactotum/foliate) ⭐ 8,726 | 🐛 319 | 🌐 JavaScript | 📅 2026-04-08 - Simple and modern eBook reader based on [Epub.js](https://github.com/futurepress/epub.js) ⭐ 6,962 | 🐛 517 | 🌐 JavaScript | 📅 2026-03-24 `#gjs` `#javascript` `#gtk4` `#libadwaita`.
...
* [Calculator](https://github.com/elementary/calculator) ⭐ 83 | 🐛 28 | 🌐 Vala | 📅 2026-09-13 - Calculator designed for elementary OS `#vala` `#gtk4` `#granite`.
...
* [Rnote](https://github.com/flxzt/rnote) ⭐ 11,636 | 🐛 451 | 🌐 Rust | 📅 2026-09-11 - Vector-based drawing app for sketching, handwritten notes and to annotate documents and pictures with pressure-sensitive stylus input support `#rust` `#gtk4` `#libadwaita`.
* [Zim](https://github.com/zim-desktop-wiki/zim-desktop-wiki) ⭐ 2,201 | 🐛 443 | 🌐 Python | 📅 2026-09-01 - Text editor used to maintain a collection of wiki pages `#python` `#gtk3`.
...
* [Folio](https://github.com/toolstack/Folio) ⭐ 282 | 🐛 54 | 🌐 Vala | 📅 2026-04-17 - Markdown note-taking application with GNOME desktop integration (Paper fork with additional features) `#vala` `#gtk4` `#libadwaita`.
...
* [PDF Arranger](https://github.com/pdfarranger/pdfarranger) ⭐ 5,873 | 🐛 85 | 🌐 Python | 📅 2026-09-01 - PDF editor with merging, splitting, rotating, cropping and rearranging based on [pikepdf](https://github.com/pikepdf/pikepdf) ⭐ 2,798 | 🐛 18 | 🌐 Python | 📅 2026-09-06 `#python` `#gtk3` `#libhandy`.
* [word-sys's PDF Editor](https://github.com/word-sys/word-sys-pdf-editor) ⭐ 88 | 🐛 1 | 🌐 Python | 📅 2026-09-13 - Simple and user-friendly PDF editor, focused on editing text content in PDF files `#python` `#gtk4` `#libadwaita`.
...
* [Pympress](https://github.com/Cimbali/pympress) ⭐ 1,656 | 🐛 40 | 🌐 Python | 📅 2026-03-29 - Presentation tool designed for dual-screen setups such as presentations and public talks `#python` `#gtk3`.
...
* [Walker](https://github.com/abenz1267/walker) ⭐ 3,042 | 🐛 25 | 🌐 Rust | 📅 2026-09-13 - Customizable application launcher for Wayland `#rust` `#gtk4`.
...
* [Planify](https://github.com/alainm23/planify) ⭐ 5,680 | 🐛 170 | 🌐 Vala | 📅 2026-09-10 - Project and task manager with Todoist support `#vala` `#gtk4` `#libadwaita`.
...
* [Getting Things GNOME](https://github.com/getting-things-gnome/gtg) ⭐ 602 | 🐛 211 | 🌐 Python | 📅 2026-09-10 - Personal task organizer for the GNOME desktop inspired by [Getting Things Done](https://gettingthingsdone.com/what-is-gtd) `#python` `#gtk3`.
...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,469 | 🐛 24 | 🌐 Python | 📅 2026-09-01 - Virtual assistant (based on GPT4All) that interacts with the system by running shell commands and execute Python code `#python` `#gtk4` `#libadwaita`.
...
* [AstraLite](https://github.com/art-den/astra_lite) ⭐ 53 | 🐛 7 | 🌐 Rust | 📅 2026-09-13 - Software for deepsky astrophotography and live stacking `#rust` `#gtk3`.
...
* [OTPClient](https://github.com/paolostivanin/OTPClient) ⭐ 558 | 🐛 2 | 🌐 C | 📅 2026-09-13 - One Time Password application that supports both TOTP and HOTP `#c` `#gtk4` `#libadwaita`.
...
* [Virtual Machine Manager (virt-manager)](https://github.com/virt-manager/virt-manager) ⭐ 3,248 | 🐛 157 | 🌐 Python | 📅 2026-09-04 - Graphical tool for managing virtual machines such as QEMU/KVM, Xen, LXC `#python` `#gtk3`.
...
* [GNvim](https://github.com/vhakulinen/gnvim) ⭐ 1,959 | 🐛 10 | 🌐 Rust | 📅 2026-06-28 - GUI for Neovim without any web bloat `#rust` `#gtk4` `#libadwaita`.
...
* [Timeshift](https://github.com/linuxmint/timeshift) ⭐ 4,276 | 🐛 231 | 🌐 Vala | 📅 2026-09-05 - System restore tool for Linux that creates filesystem snapshots using rsync or Btrfs snapshots `#vala` `#gtk3`.
...
* [Popsicle](https://github.com/pop-os/popsicle) ⭐ 854 | 🐛 29 | 🌐 Rust | 📅 2026-09-01 - Utility for flashing multiple USB devices in parallel `#rust` `#gtk3`.
...
* [Nemo](https://github.com/linuxmint/nemo) ⭐ 1,559 | 🐛 324 | 🌐 C | 📅 2026-09-08 - Default file manager of the Cinnamon desktop (fork of Nautilus) `#c` `#gtk3`.
* [Files (elementary)](https://github.com/elementary/files) ⭐ 365 | 🐛 334 | 🌐 Vala | 📅 2026-09-13 - File browser for elementary OS `#vala` `#gtk3` `#libhandy` `#granite`.
...
* [FSearch](https://github.com/cboxdoerfer/fsearch) ⭐ 4,360 | 🐛 177 | 🌐 C | 📅 2026-09-12 - A fast file search utility `#c` `#gtk3`.
...
* [ProtonPlus](https://github.com/Vysp3r/ProtonPlus) ⭐ 1,770 | 🐛 49 | 🌐 Vala | 📅 2026-09-13 - Proton version manager `#vala` `#gtk4` `#libadwaita`.
* [Extension Manager](https://github.com/mjakeman/extension-manager) ⭐ 1,364 | 🐛 31 | 🌐 C | 📅 2026-09-12 - Utility for browsing and installing GNOME Shell Extensions `#c` `#gtk4` `#libadwaita`.
* [Shelly](https://github.com/Seafoam-Labs/Shelly-ALPM) ⭐ 1,113 | 🐛 39 | 🌐 Zig | 📅 2026-09-13 - Package manager for Arch Linux, CachyOS supporting AUR, Flathub, Flatpak, AppImage, and native Arch Linux packages `#zig` `#gtk4`.
...
* [Czkawka](https://github.com/qarmin/czkawka) ⭐ 33,444 | 🐛 323 | 🌐 Fluent | 📅 2026-09-09 - Cross-platform, simple and fast application to remove unnecessary files from your computer `#rust` `#gtk4`.
...
* [Solaar](https://github.com/pwr-Solaar/Solaar) ⭐ 9,355 | 🐛 108 | 🌐 Python | 📅 2026-08-18 - Manager for many Logitech keyboards, mice, and other devices that connect wirelessly to a Unifying, Bolt, Lightspeed or Nano receiver, USB cable or Bluetooth `#python` `#gtk3`.
* [LACT](https://github.com/ilya-zlobintsev/LACT) ⭐ 5,581 | 🐛 98 | 🌐 Rust | 📅 2026-09-13 - Application to control AMD, Nvidia or Intel graphical processing units (GPU) on Linux `#rust` `#gtk4` `#libadwaita`.
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 5,270 | 🐛 137 | 🌐 Rust | 📅 2026-09-07 - Mouse and keyboard sharing software (software KVM switch) designed for Wayland `#rust` `#gtk4` `#libadwaita`.
* [Hidamari](https://github.com/jeffshee/hidamari) ⭐ 2,106 | 🐛 130 | 🌐 Python | 📅 2026-07-09 - Application to configure video wallpaper for X11 and Wayland `#python` `#gtk3`.
* [Flatseal](https://github.com/tchx84/Flatseal) ⭐ 1,774 | 🐛 97 | 🌐 JavaScript | 📅 2026-08-31 - Flatpak permission manager `#gjs` `#javascript` `#gtk4` `#libadwaita`.
...
* [Warehouse](https://github.com/flattool/warehouse) ⭐ 621 | 🐛 75 | 🌐 Python | 📅 2026-07-22 - Toolbox for managing Flatpak packages (view info, manage user data, pin versions, change version, install/uninstall, etc.) `#python` `#gtk4` `#libadwaita`.
...
* [Monitor](https://github.com/stsdc/monitor) ⭐ 362 | 🐛 39 | 🌐 Vala | 📅 2026-09-13 - Manage processes and monitor system resources `#vala` `#gtk4` `#libadwaita` `#granite`.
...
* [DeSmuME](https://github.com/TASEmulators/desmume) ⭐ 3,632 | 🐛 92 | 🌐 C++ | 📅 2026-09-11 - Cross-platform Nintendo DS emulator `#c++` `#gtk3`.
