...
* [Riff](https://github.com/Diegovsky/riff) ⭐ 300 | 🐛 28 | 🌐 Rust | 📅 2026-09-25 - Spotify (premium) client for the GNOME desktop with MPRIS integration based on [librespot](https://github.com/librespot-org/librespot) ⭐ 7,173 | 🐛 140 | 🌐 Rust | 📅 2026-09-11, fork of [Spot](https://github.com/xou816/spot) ⭐ 2,366 | 🐛 114 | 🌐 Rust | 📅 2025-10-13 `#rust` `#gtk4` `#libadwaita`.
...
* [Mpdevil](https://github.com/SoongNoonien/mpdevil) ⭐ 250 | 🐛 1 | 🌐 Python | 📅 2026-09-25 - MPD music browser with MPRIS interface `#python` `#gtk4` `#libadwaita`.
...
* [zrythm](https://github.com/zrythm/zrythm) ⭐ 3,130 | 🐛 2 | 🌐 C++ | 📅 2026-09-23 - DAW offering streamlined editing workflows with automation capabilities, chord assistance and support for plugins `#c++` `#gtk4` `#libadwaita`.

### Audio Tools

* [SongRec](https://github.com/marin-m/SongRec) ⭐ 1,969 | 🐛 71 | 🌐 Rust | 📅 2026-09-05 - Shazam GUI client `#rust` `#gtk3`.
...
* [ALSA Scarlett2 Control Panel (alsa-scarlett-gui)](https://github.com/geoffreybennett/alsa-scarlett-gui) ⭐ 1,342 | 🐛 85 | 🌐 C | 📅 2026-06-22 - GUI for the Focusrite USB audio interfaces (Scarlett Gen 2, 3, 4, Clarett, and Vocaster) for instrument, microphone or MIDI recording `#c` `#gtk4`.
...
* [Kooha](https://github.com/SeaDve/Kooha) ⭐ 3,515 | 🐛 100 | 🌐 Rust | 📅 2026-09-25 - Distraction-free screen recorder `#rust` `#gtk4` `#libadwaita`.
...
* [Vipsdisp](https://github.com/jcupitt/vipsdisp) ⭐ 237 | 🐛 8 | 🌐 C | 📅 2026-09-17 - Image viewer capable of displaying huge (i.e. GB sizes) images based on [`libvips`](https://github.com/libvips/libvips) ⭐ 11,675 | 🐛 78 | 🌐 C | 📅 2026-09-25 and supporting many scientific and technical image formats `#c` `#gtk4`.
...
* [Horizon](https://github.com/horizon-eda/horizon) ⭐ 1,319 | 🐛 165 | 🌐 C | 📅 2026-09-25 - EDA package supporting an integrated end-to-end workflow for printed circuit design `#c++` `#gtk3`.
...
* [Parabolic](https://github.com/NickvisionApps/Parabolic) ⭐ 7,153 | 🐛 100 | 🌐 C# | 📅 2026-06-29 - [yt-dlp](https://github.com/yt-dlp/yt-dlp) ⭐ 193,567 | 🐛 2,682 | 🌐 Python | 📅 2026-09-16 graphical fronted `#csharp` `#gtk4` `#libadwaita`.
* [Gydl](https://github.com/JannikHv/gydl) ⭐ 156 | 🐛 16 | 🌐 Python | 📅 2025-11-28 - GUI wrapper around [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,361 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19 `#python` `#gtk3`.
...
* [Hylki](https://github.com/hyprlab/hylki) ⭐ 103 | 🐛 16 | 🌐 Rust | 📅 2026-09-25 - Email client for the GNOME desktop that aims to be privacy-first, fast with a clean interface `#rust` `#gtk4` `#libadwaita`.
...
* [Varia](https://github.com/giantpinkrobots/varia) ⭐ 1,866 | 🐛 58 | 🌐 Python | 📅 2026-09-14 - Download manager based on [aria2](https://github.com/aria2/aria2) ⭐ 42,720 | 🐛 1,179 | 🌐 C++ | 📅 2026-06-25 `#python` `#gtk4` `#libadwaita`.
...
* [Open Download Manager](https://github.com/albilu/open-download-manager) ⭐ 1 | 🐛 0 | 🌐 Java | 📅 2026-09-25 - Download manager based on aria2, yt-dlp and HTTrack with torrents, scheduling and Tor routing `#java` `#gtk4` `#libadwaita`.
...
* [Field Monitor](https://github.com/theCapypara/field-monitor) ⭐ 97 | 🐛 19 | 🌐 Rust | 📅 2026-09-19 - Remote desktop client for the GNOME desktop with support for Proxmox & QEMU/KVM virtual machines `#rust` `#gtk4` `#libadwaita`.
...
* [Proton VPN](https://github.com/ProtonVPN/proton-vpn-gtk-app) ⭐ 766 | 🐛 88 | 🌐 Python | 📅 2026-09-14 - GTK fronted for Proton VPN `#python` `#gtk3`.
* [Haguichi](https://haguichi.net) - Graphical fronted for Hamachi `#vala` `#gtk4` `#libadwaita`.

### Web Browsers

* [Add Water](https://flathub.org/en/apps/dev.qwery.AddWater) - Utility to install the [GNOME theme for Mozilla Firefox](https://github.com/rafaelmardojai/firefox-gnome-theme) ⭐ 3,906 | 🐛 57 | 🌐 CSS | 📅 2026-07-09 `#python`  `#gtk4` `#libadwaita`.
...
* [Linux Wifi Hotspot](https://github.com/lakinduakash/linux-wifi-hotspot) ⭐ 4,401 | 🐛 196 | 🌐 Shell | 📅 2026-09-17 - Feature-rich wifi hotspot creator for Linux which provides both GUI and command-line interface `#c` `#gtk3`.
...
* [Foliate](https://github.com/johnfactotum/foliate) ⭐ 8,762 | 🐛 320 | 🌐 JavaScript | 📅 2026-04-08 - Simple and modern eBook reader based on [Epub.js](https://github.com/futurepress/epub.js) ⭐ 6,965 | 🐛 517 | 🌐 JavaScript | 📅 2026-03-24 `#gjs` `#javascript` `#gtk4` `#libadwaita`.
...
* [Rnote](https://github.com/flxzt/rnote) ⭐ 11,706 | 🐛 449 | 🌐 Rust | 📅 2026-09-25 - Vector-based drawing app for sketching, handwritten notes and to annotate documents and pictures with pressure-sensitive stylus input support `#rust` `#gtk4` `#libadwaita`.
* [Zim](https://github.com/zim-desktop-wiki/zim-desktop-wiki) ⭐ 2,204 | 🐛 446 | 🌐 Python | 📅 2026-09-01 - Text editor used to maintain a collection of wiki pages `#python` `#gtk3`.
...
* [gImageReader](https://github.com/manisandro/gImageReader) ⭐ 1,996 | 🐛 75 | 🌐 C++ | 📅 2026-01-15 - GTK/Qt front-end to [Tesseract] `#c++` `#gtk3`.
...
* [PDF Arranger](https://github.com/pdfarranger/pdfarranger) ⭐ 5,926 | 🐛 88 | 🌐 Python | 📅 2026-09-01 - PDF editor with merging, splitting, rotating, cropping and rearranging based on [pikepdf](https://github.com/pikepdf/pikepdf) ⭐ 2,807 | 🐛 18 | 🌐 Python | 📅 2026-09-25 `#python` `#gtk3` `#libhandy`.
* [word-sys's PDF Editor](https://github.com/word-sys/word-sys-pdf-editor) ⭐ 107 | 🐛 1 | 🌐 Python | 📅 2026-09-25 - Simple and user-friendly PDF editor, focused on editing text content in PDF files `#python` `#gtk4` `#libadwaita`.
...
* [Pympress](https://github.com/Cimbali/pympress) ⭐ 1,669 | 🐛 43 | 🌐 Python | 📅 2026-03-29 - Presentation tool designed for dual-screen setups such as presentations and public talks `#python` `#gtk3`.
...
* [Walker](https://github.com/abenz1267/walker) ⭐ 3,059 | 🐛 24 | 🌐 Rust | 📅 2026-09-25 - Customizable application launcher for Wayland `#rust` `#gtk4`.
* [StreamController](https://github.com/StreamController/StreamController) ⭐ 1,119 | 🐛 32 | 🌐 Python | 📅 2026-09-21 - Elgato Stream Deck controller with support for plugins `#python` `#gtk4` `#libadwaita`.
...
* [Minder](https://github.com/phase1geo/Minder) ⭐ 1,204 | 🐛 49 | 🌐 Vala | 📅 2026-09-25 - Mind-mapping application for elementary OS `#vala` `#gtk4` `#granite`.

### Project Management

* [Planify](https://github.com/alainm23/planify) ⭐ 5,705 | 🐛 182 | 🌐 Vala | 📅 2026-09-21 - Project and task manager with Todoist support `#vala` `#gtk4` `#libadwaita`.
...
* [Newelle](https://github.com/qwersyk/Newelle) ⭐ 1,477 | 🐛 20 | 🌐 Python | 📅 2026-09-16 - Virtual assistant (based on GPT4All) that interacts with the system by running shell commands and execute Python code `#python` `#gtk4` `#libadwaita`.
...
* [AstraLite](https://github.com/art-den/astra_lite) ⭐ 53 | 🐛 7 | 🌐 Rust | 📅 2026-09-24 - Software for deepsky astrophotography and live stacking `#rust` `#gtk3`.
...
* [Virtual Machine Manager (virt-manager)](https://github.com/virt-manager/virt-manager) ⭐ 3,257 | 🐛 158 | 🌐 Python | 📅 2026-09-04 - Graphical tool for managing virtual machines such as QEMU/KVM, Xen, LXC `#python` `#gtk3`.
* [Pods](https://github.com/marhkb/pods) ⭐ 1,093 | 🐛 41 | 🌐 Rust | 📅 2026-07-23 - Podman containers manager `#rust` `#gtk4` `#libadwaita`.
* [BoxBuddy](https://github.com/Dvlv/BoxBuddyRS) ⭐ 561 | 🐛 43 | 🌐 Rust | 📅 2026-09-05 - Graphical interface for Distrobox `#rust` `#gtk4` `#libadwaita`.
...
* [neovim-gtk](https://github.com/Lyude/neovim-gtk) ⭐ 176 | 🐛 51 | 🌐 Rust | 📅 2026-09-25 - GUI for Neovim with ligatures support `#rust` `#gtk4`.
...
* [elementary Code](https://github.com/elementary/code) ⭐ 522 | 🐛 153 | 🌐 Vala | 📅 2026-09-24 - Code editor designed for elementary OS `#vala` `#gtk3` `#granite` `#elementary`.
...
* [Timeshift](https://github.com/linuxmint/timeshift) ⭐ 4,289 | 🐛 232 | 🌐 Vala | 📅 2026-09-21 - System restore tool for Linux that creates filesystem snapshots using rsync or Btrfs snapshots `#vala` `#gtk3`.
...
* [Files (elementary)](https://github.com/elementary/files) ⭐ 365 | 🐛 337 | 🌐 Vala | 📅 2026-09-25 - File browser for elementary OS `#vala` `#gtk3` `#libhandy` `#granite`.
...
* [FSearch](https://github.com/cboxdoerfer/fsearch) ⭐ 4,379 | 🐛 175 | 🌐 C | 📅 2026-09-22 - A fast file search utility `#c` `#gtk3`.
...
* [ProtonPlus](https://github.com/Vysp3r/ProtonPlus) ⭐ 1,808 | 🐛 50 | 🌐 Vala | 📅 2026-09-23 - Proton version manager `#vala` `#gtk4` `#libadwaita`.
...
* [Shelly](https://github.com/Seafoam-Labs/Shelly-ALPM) ⭐ 1,153 | 🐛 33 | 🌐 Zig | 📅 2026-09-25 - Package manager for Arch Linux, CachyOS supporting AUR, Flathub, Flatpak, AppImage, and native Arch Linux packages `#zig` `#gtk4`.
...
* [AdwSteamGtk](https://github.com/Foldex/AdwSteamGtk) ⭐ 390 | 🐛 6 | 🌐 Python | 📅 2026-09-04 - [Adwaita for Steam](https://github.com/tkashkin/Adwaita-for-Steam) ⭐ 1,594 | 🐛 19 | 🌐 CSS | 📅 2026-08-02 skin installer `#python` `#gtk4` `#libadwaita`.
...
* [Czkawka](https://github.com/qarmin/czkawka) ⭐ 33,729 | 🐛 328 | 🌐 Fluent | 📅 2026-09-16 - Cross-platform, simple and fast application to remove unnecessary files from your computer `#rust` `#gtk4`.
...
* [LACT](https://github.com/ilya-zlobintsev/LACT) ⭐ 5,651 | 🐛 99 | 🌐 Rust | 📅 2026-09-25 - Application to control AMD, Nvidia or Intel graphical processing units (GPU) on Linux `#rust` `#gtk4` `#libadwaita`.
* [Lan Mouse](https://github.com/feschber/lan-mouse) ⭐ 5,314 | 🐛 139 | 🌐 Rust | 📅 2026-09-24 - Mouse and keyboard sharing software (software KVM switch) designed for Wayland `#rust` `#gtk4` `#libadwaita`.
* [Hidamari](https://github.com/jeffshee/hidamari) ⭐ 2,120 | 🐛 132 | 🌐 Python | 📅 2026-07-09 - Application to configure video wallpaper for X11 and Wayland `#python` `#gtk3`.
* [Flatseal](https://github.com/tchx84/Flatseal) ⭐ 1,788 | 🐛 98 | 🌐 JavaScript | 📅 2026-09-22 - Flatpak permission manager `#gjs` `#javascript` `#gtk4` `#libadwaita`.
...
* [Monitor](https://github.com/stsdc/monitor) ⭐ 361 | 🐛 47 | 🌐 Vala | 📅 2026-09-25 - Manage processes and monitor system resources `#vala` `#gtk4` `#libadwaita` `#granite`.
...
* [DeSmuME](https://github.com/TASEmulators/desmume) ⭐ 3,644 | 🐛 92 | 🌐 C++ | 📅 2026-09-11 - Cross-platform Nintendo DS emulator `#c++` `#gtk3`.
* [An Anime Game launcher](https://github.com/an-anime-team/an-anime-game-launcher) ⭐ 2,255 | 🐛 115 | 🌐 Fluent | 📅 2026-09-24 - Genshin Impact launcher for Linux with telemetry disabling `#rust` `#gtk4` `#relm4` `#libadwaita`.
...
* [BLE Sync Cycle](https://github.com/richbl/go-ble-sync-cycle) ⭐ 30 | 🐛 6 | 🌐 Go | 📅 2026-09-25 - Indoor cycling application synchronizing video playback with real-time cycling data from Bluetooth Low Energy (BLE) devices `#go` `#gtk4` `#libadwaita`.
...
* [Butler](https://github.com/cassidyjames/butler) ⭐ 215 | 🐛 24 | 🌐 Vala | 📅 2026-09-01 - Native UI wrapper for the Home Assistant dashboard `#vala` `#gtk4` `#libadwaita`.
